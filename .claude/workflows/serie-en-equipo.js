export const meta = {
  ...
  description: 'Hacer las biblias de un lote en cadena con subagentes: recolector, 4 investigadores (Sonnet), redactor (Opus), cierre. args: {lote: "G", max: 6} o {ids: [...]}, y opcional esfuerzo: {inv, red, aux}',
