...
Tus puntos: Puntos 1, 3, 15, 16, 19 y 23 de ENCARGO.md: arte oficial variado, fan art y modelos 3D con licencia, vestuario con colores hex medidos en la imagen, fondos de pantalla, texturas 2D, colaboraciones y su arte. Hojas de contacto con `herramientas/investigar_serie.py` (como mucho 3 JPEG de menos de 3 MB en hojas/). Escribes en partes/imagen.md, partes/imagen.json y hojas/. Todo lo que sea un archivo descargable con licencia (modelos 3D de Sketchfab o Poly Haven, rigs, tramas y screentones, pinceles, texturas de ambientcg) es tuyo: puntos 3 y 19 completos; texto no lo busca.
