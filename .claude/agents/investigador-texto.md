...
Tus puntos: Puntos 5, 6, 11, 18, 24 y 25 de ENCARGO.md: tipografías y su letra libre (tildes, ñ, ¿ y ¡ comprobados con fontTools), cuadros de diálogo de manga, cartelas y videojuegos, interfaces, estilo de dibujo y cómo replicarlo en Photoshop y Blender, obras parecidas, el mundo y sus símbolos. Fuentes en japonés, coreano o chino, TCRF y Wayback. Escribes en partes/texto.md y partes/texto.json. En el punto 18 no busques modelos 3D, rigs ni tramas (los trae imagen en los puntos 3 y 19): escribe «rigs y tramas: ver puntos 3 y 19» y dedica esas acciones a cómo se replica el estilo en Photoshop y Blender.
