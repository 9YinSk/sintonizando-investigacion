# Parte de IMAGEN · Neon Genesis Evangelion (repaso, red abierta)

Investigador de imagen del equipo (EQUIPO.md). Puntos 1, 3, 15, 16, 19 y 23 de
ENCARGO.md. Repaso de una biblia hecha con la red cerrada (`biblia.md` actual,
1399 líneas, sin hojas de contacto ni imágenes vistas): esta parte confirma lo
que ya tenía con fuente y añade lo que faltaba, ahora con la red abierta.

## Índice
1 arte oficial · 3 fan art y 3D · 15 vestuario · 16 fondos de pantalla ·
19 texturas 2D · 23 colaboraciones · lo mejor para la lámina · no encontré ·
bitácora.

## 1 · Arte oficial, en cantidad y variado

Corrí `herramientas/investigar_serie.py --serie "Neon Genesis Evangelion" --wiki
evangelion --paginas "Shinji Ikari" "Rei Ayanami" "Asuka Langley Soryu" "Misato
Katsuragi" "Gendo Ikari" "Kaworu Nagisa"`: 455 imágenes enlazadas, 208 grandes,
...
- **Settei/genga oficiales de producción** (hoja 3, números 105-119 y 122-130):
  ...
  japonés («決定稿» = versión final), varios sellados «Tumblr nt...1280» que
  reenvían escaneos de artbooks de producción · fuente: galería de
  evangelion.fandom.com · ⚠️ (el tumblr de origen no cita el libro exacto)
- **Figuras oficiales fotografiadas** (sirven de referencia 3D real, punto 23
  también): «Ichiban Kuji Neon Genesis Evangelion 30th Anniversary Prize B y
  C» (2025, premio de sorteo japonés Ichiban Kuji, Bandai Spirits) y «S-FIRE
  Evangelion 3.0+1.0 Thrice Upon a Time Figure - Asuka Langley» (figura de
  escala, pose sentada en la playa) · [Prize C](https://static.wikia.nocookie.net/evangelion/images/c/ca/Ichiban_Kuji_Neon_Genesis_Evangelion_30th_Anniversary_Prize_C.jpg) · [S-FIRE Asuka](https://static.wikia.nocookie.net/evangelion/images/e/ea/S-FIRE_Evangelion_3.0%2B1.0_Thrice_Upon_a_Time_Figure_-_Asuka_Langley_1.jpg) · ✅ (vistas, 1000×1000)
- **Diseño de personajes**: Yoshiyuki Sadamoto (también manga) · **diseño de
  las Eva**: Ikuto Yamashita, autor del «Media Works Super Robot Encyclopedia»
  (5672×7108, hoja 1 nº1) y del logo del 30 aniversario · **dirección de
  arte**: Hiroshi Katō · confirmado con la propia imagen (créditos en el
  nombre del archivo de la wiki) y [ANN](https://www.animenewsnetwork.com/encyclopedia/people.php?id=16) ✅
- **Libros de arte** (ya en la biblia, confirmo que siguen a la venta):
  *Der Mond* (Sadamoto, 1999) y *Die Sterne* (2003, varios artistas de Gainax)
  · [Evangelion Wiki: Der Mond](https://evangelion.fandom.com/wiki/Der_Mond) ✅
  · el nuevo libro de Sadamoto (10-nov-2026) sigue anunciado en
  [eva-info.jp](https://www.eva-info.jp/27248) ✅
- **30 aniversario 2025-2026**: la web [30th.evangelion.jp](https://30th.evangelion.jp/)
  sigue activa con secciones #Official e #Items; la exposición «ALL OF
  EVANGELION» (14-nov-2025 a 12-ene-2026, Tokyo City View) tiene fotos en
  [Animate Times](https://www.animatetimes.com/news/details.php?id=1763006385) ✅
- **Ichiban Kuji «Evangelion 30th Anniversary»** (lotería japonesa, sale a la
  venta el 6-feb-2026, 790 yenes por tirada): premio A, una figura de la
  Unidad 01 desplegando las alas de la apertura, 26 cm de cuerpo y 43 cm total
  · [Toy People](https://www.toy-people.com/en/?p=107064) ✅ y
  [Otaku House](https://shop.otakuhouse.com/en-us/products/ichiban-kuji-evangelion-30th-anniversary-full-set-of-60) ✅

## 3 · Fan art y renders 3D (referencia) y modelos 3D con licencia

Confirmé licencias por la **API de Sketchfab**
(`https://api.sketchfab.com/v3/search?type=models&q=<término>&downloadable=true`),
que da la licencia exacta y las caras del modelo (todo lo de abajo sigue
descargable a fecha de hoy, 26-sep-2026):

| Modelo | Autor | Licencia | Caras | Para qué | Enlace |
|---|---|---|---|---|---|
| Clipboard | cookiepop | **CC BY** | 2.256 | Tablilla de la ficha de piloto NERV | [Sketchfab](https://sketchfab.com/3d-models/none-a37158f20ccf436483029e8295629738) |
| Cello | Lordricker | **CC BY** | 134.552 | El chelo de Shinji (ep. 15) | [Sketchfab](https://sketchfab.com/3d-models/none-d67ed4cbbc0c4477ba5d89413e715c82) |
| Sony Walkman TPS-L2 Cassette Player | berilbaska | **CC BY** | 11.215 | Base para el SDAT de Shinji (el real es un Sony WMD-DT1, pero no hay malla libre de ese modelo exacto) | [Sketchfab](https://sketchfab.com/3d-models/none-3cad4141c9aa4e67ba1d2ab1e5b9d277) |
| Evangelion unit 01 | lefort | **CC BY** | ⚠️ (no la dio la API en esta consulta) | Unidad 01, pose libre | [Sketchfab](https://sketchfab.com/3d-models/none-49c7a77272c84154a711d7cfd5cb47f4) |
| Evangelion Unit-01 | allanromanreyes | **CC BY-SA** | — | Unidad 01, serie completa de Evas del mismo autor (00, 01, 02, 03 y de producción en masa) | [Sketchfab](https://sketchfab.com/3d-models/none-9fddeb0a7143436598c805dab2f147bf) |
| **Neon Genesis Evangelion — Asuka Langley Sohryu / Rig** | JoeTrekV | **CC BY** | 6.752 | Asuka **con esqueleto**: sirve para posarla igual que pide el punto 14 | [Sketchfab](https://sketchfab.com/3d-models/none-5e66c14e43164330a6dbd4bc863913f7) |
| Evangelion - Eva 01 Rigged | najwanazhiim | **CC BY** | 873.951 (muy pesado) | Unidad 01 con esqueleto | [Sketchfab](https://sketchfab.com/3d-models/none-cec471affcb445cb9231bba50267191a) |
| EVANGELION MARI (RIGGED, UPDATED) | browniecoats | **CC BY** | 241.778 | Mari con esqueleto | [Sketchfab](https://sketchfab.com/3d-models/none-82bcdbde1483490f896418476b2c9d6f) |
| Gendo Ikari - Evangelion | 185684 | **CC BY** | 1.598 (bajo poly) | Busto de Gendo | [Sketchfab](https://sketchfab.com/3d-models/none-49a40e59a5b34ed7b34838027d573809) |
| Pen pen - evangelion. Rig | sirliks | **CC BY** | 349.168 | Pen Pen con esqueleto (mascota de Misato) | [Sketchfab](https://sketchfab.com/3d-models/none-7672ac8bd3454ff9aee30d270874d01d) |
| Sachiel - Evangelion | solodovnykov | **CC BY** | — | El 3.º Ángel (el primero que ataca Tokio-3) | [Sketchfab](https://sketchfab.com/3d-models/none-3c212c7ce6ac4284a8b718078bc6fc0f) |
| Lilith - Evangelion (dos versiones) | solodovnykov | **CC BY** | — | Lilith crucificada del GeoFront | [Sketchfab](https://sketchfab.com/3d-models/none-c8c4c0f24f854f8084f8038a34057d9d) |

Todos piden crédito (CC BY) menos los marcados CC BY-SA (crédito + compartir
igual). **El diseño en sí sigue siendo de Khara**: usar estas mallas como base
o referencia de pose, nunca presentarlas como merchandising oficial.

**Fan art como referencia** (nunca para pegar, con autor):
- [Pixiv, etiqueta エヴァンゲリオン](https://www.pixiv.co.jp/en/tags/%E3%82%A8%E3%83%B4%E3%82%A1%E3%83%B3%E3%82%B2%E3%83%AA%E3%82%AA%E3%83%B3) (más de 65.000 dibujos) y el
  [concurso de ilustración del 30 aniversario](https://www.pixiv.co.jp/2025/07/15/120000) con efecto de «campo AT» ✅
- Danbooru/Safebooru: etiquetas más repetidas por personaje ya sacadas en
  `datos-imagen.md` (vocabulario de pose y ropa que entienden las IA de imagen,
  útil para el punto 17) ✅
- [Behance: Neon Genesis Evangelion Screen Graphics](https://www.behance.net/gallery/96540159/Neon-Genesis-Evangelion-Screen-Graphics)
  de Pedro Fleming: recreación limpia de las pantallas de NERV, sirve de
  referencia de UI ✅

## 15 · Vestuario, con hex medidos de verdad

La biblia vieja decía «todo de memoria, hex aproximados». Los bajé y medí con
Pillow (mediana de un parche de 6-12 px, sin líneas de contorno) en las
imágenes oficiales de abajo — no son de fans.

| Personaje | Prenda | Hex medido | De qué imagen |
|---|---|---|---|
| Shinji Ikari | Traje de conector azul (cuerpo) | `#036ED3` | [Shinji In Plugsuit (Mugshot).png](https://static.wikia.nocookie.net/evangelion/images/d/dd/Shinji_In_Plugsuit_%28Mugshot%29.png), arte oficial de merchandising, fondo transparente |
| Shinji Ikari | Traje de conector, panel blanco del torso | `#DCEFF3` | misma imagen |
| Shinji Ikari | Anillo del cuello (rojo) | `#8B2A2C`* | misma imagen (*zona en sombra; el rojo iluminado es más vivo, tipo `#C23B2E`) |
| Shinji Ikari | Pelo | `#583535` | misma imagen |
| Asuka Langley | Uniforme escolar: falda/pichi azul marino | `#022A51` | [Asuka Langley Soryu in her iconic outfit.png](https://static.wikia.nocookie.net/evangelion/images/4/46/Asuka_Langley_Soryu_in_her_iconic_outfit.png), arte oficial, fondo transparente |
| Asuka Langley | Uniforme escolar: blusa | `#D5E0DA` | misma imagen (blanco con sombreado azulado, no blanco puro) |
| Asuka Langley | Uniforme escolar: listón del cuello | `#A5190D` | misma imagen |
| Asuka Langley | Pelo | `#A5360F` | misma imagen |
| Asuka Langley | Traje de conector rojo | `#A31812`⚠️ | figura oficial [S-FIRE Asuka (3.0+1.0)](https://static.wikia.nocookie.net/evangelion/images/e/ea/S-FIRE_Evangelion_3.0%2B1.0_Thrice_Upon_a_Time_Figure_-_Asuka_Langley_1.jpg): foto de producto con luz ambiental roja de fondo, puede estar un poco subido; comprobar contra un fotograma neutro |
| Rei Ayanami | Traje de conector blanco (cuerpo) | `#E9EDF3` | [Rei Ayanami (Damaged Plugsuit).png](https://static.wikia.nocookie.net/evangelion/images/a/a0/Rei_Ayanami_%28Damaged_Plugsuit%29.png), arte oficial, fondo transparente |
| Rei Ayanami | Traje de conector, banda verde del pecho | `#466440` | misma imagen |
| Rei Ayanami | Pelo | `#B0C4E4` | misma imagen |
| Misato Katsuragi | Chaqueta roja (parte iluminada) | `#E02824` | [Katsuragi.Misato.full.71156.jpg](https://static.wikia.nocookie.net/evangelion/images/6/69/Katsuragi.Misato.full.71156.jpg), ilustración oficial de la wiki, fondo liso |
| Misato Katsuragi | Vestido/falda negra | `#100B0D` | misma imagen |
...
esos hex (Gendo) están marcados ⚠️ aunque tengan «dos fuentes» de forma
(el corte de la prenda coincide con el resto de arte oficial). Los mejores
para citar sin duda son los de **arte con fondo transparente o liso**
(Shinji, Asuka uniforme, Rei, Misato): ahí no hay iluminación de escena que
lo tiña.

Esto coincide con lo que decía `datos-imagen.md` (texto de Fandom): «Shinji's
plug suit has a very light blue torso... dark blue... black portions», «Misato
wears a sleeveless black flapper dress... fancy red jacket», confirmando los
hex de arriba con **dos fuentes** (texto + medición directa) ✅.

## 16 · Fondos de pantalla (oficiales y de fans en alta)

`datos-imagen.md` traía la sección de Wallhaven vacía (falló al recolectar).
La corrí a mano contra la **API pública de Wallhaven**
(`https://wallhaven.cc/api/v1/search?q=neon+genesis+evangelion&sorting=favorites`),
sólo contenido apto, ordenado por favoritos:

| Fondo | Tamaño | Autor (subida) | Favoritos | Enlace |
|---|---|---|---|---|
| Personajes + Eva, paleta oscura | 6600×3000 | Rocketizada | 1.007 | [wallhaven.cc/w/kw6x56](https://wallhaven.cc/w/kw6x56) |
| — | 1920×1080 | wallpaperengine | 734 | [wallhaven.cc/w/6ople6](https://wallhaven.cc/w/6ople6) |
| — | 8000×4133 | SRWCharacter | 585 | [wallhaven.cc/w/weolkp](https://wallhaven.cc/w/weolkp) |
| — | 3840×2160 | KetewStudio | 584 | [wallhaven.cc/w/yqmlmx](https://wallhaven.cc/w/yqmlmx) |
| — | 2608×3877 | (cuenta borrada) | 542 | [wallhaven.cc/w/72159y](https://wallhaven.cc/w/72159y) |

Todas ✅ (tamaño real confirmado por la propia API, no de memoria). Ninguna
dice su licencia: son fondos de fans, hay que mirarlos uno a uno antes de citar
