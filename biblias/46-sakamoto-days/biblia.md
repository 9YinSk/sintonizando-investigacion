...
serie: "Sakamoto Days (サカモトデイズ)"
canal: "sin canal: propuesta #📰・noticias-anime (alternativas #🎬・castings y #🪪・presentaciones, ver §0)"
fecha: 2026-09-26
---

# Biblia · Sakamoto Days — para la biblioteca

> [!important] Cómo se hizo, y sus límites
> - La escribió el **redactor** sólo con las partes del equipo
>   (`partes/imagen.md`, `video.md`, `voz.md`, `texto.md` y, para un dato
>   suelto, los `datos-*.md`). Nada nuevo sin fuente.
> - **YouTube pidió iniciar sesión** toda la tanda y **AnimeThemes estaba
>   caído** (HTTP 522). Los vídeos se miraron en **Dailymotion** (dos
>   tráileres oficiales de Netflix, uno doblado al latino, y una escena del
>   episodio 1) y en **Internet Archive** (opening 1 a 720p). No hubo 1080p.
> - **Frases del doblaje latino**: 8 textuales, oídas con `voz.py` en el
>   tráiler oficial de Netflix doblado (§10). Doblaje Wiki no tiene
>   muestras de audio de esta serie.
> - El redactor **miró las 3 hojas de `hojas/` número a número** y corrigió
>   cosas de las partes. La más grave: el «Lu» que se investigó en imagen y
>   vídeo es **Lu Wutang**, un chico de trenza negra, y **no** la Lu del trío
>   protagonista, que es **Lu Shaotang**, la chica de pelo rosa (§28).
> - **Sin serie hermana**: Sakamoto Days sale una sola vez en `encargos/`.
...
> - En `referencias.json` se quitaron **43 entradas ajenas** a la serie
>   (fan art de otras obras y fotos de Flickr de una autora que se apellida
>   Sakamoto). Quedan 122.
...
0. Sakamoto Days no tiene canal: dónde encaja mejor
...
7. Cómo hablan en pantalla: cartelas, globos y la caja del juego [6]
...
El encargo dice por qué está: **reciente y muy compartido**. Las partes lo
confirman. El anime tuvo el **mejor estreno de un anime en la historia de
Netflix** (8,6 millones de vistas la primera semana) y fue el anime **más
visto de Netflix** en el primer semestre de 2025 (§22). Llegó con
**doblaje latino simultáneo** (§10). Y en 2026 estrenó película de acción
real en Japón (§25).

Lo propio de la serie, lo que no tiene ninguna otra del servidor: **la
tienda de barrio** de los Sakamoto. Por fuera, un negocio normal. Por
dentro, un arsenal escondido bajo la caja registradora (§26). Todo el
humor sale de ese choque: **日常と非日常**, «lo cotidiano y lo que no lo
es», como dice una portada a color (hoja 2 nº81).

Miré los textos reales de `servidor/inventario.md` y lo que proponen las
otras biblias (`grep '^canal:' biblias/*/biblia.md`). Las biblias son
generales: el canal es sólo una propuesta y un choque no bloquea nada
(decisión del dueño, 25-sep).

### 0.1 La propuesta

| Orden | Canal | Texto real del inventario | Por qué Sakamoto Days | Choca con |
|---|---|---|---|---|
| **A (recomendado)** | **ıı・📰・noticias-anime** (📡 NOTICIAS, texto) | «Anime: estrenos, temporadas y doblajes. Lo trae un bot. Para comentar, abre un hilo en la noticia.» | La serie publica sus fichas como el **回覧板** (*kairanban*) de la tienda: «坂本商店回覧板», la tablilla de avisos que pasa de casa en casa en un barrio japonés (hoja 2 nº65, hoja 1 nº46). Es un noticiero de barrio **dibujado por el propio autor**. Además, Sakamoto sale **leyendo el periódico** en la puerta de la tienda (hoja 1 nº15) | nadie lo pide; es de los seis canales «por decidir» (encargo 29) |
| B | **ıı・🎬・castings** (EL ESTUDIO, foro) | «Cada casting es un hilo. Ciérralo cuando el papel esté cubierto.» | Portada a color del capítulo 168: **«祝・TVアニメ化決定!»** («¡Celebramos: tendrá anime!»). Sakamoto lleva una **cámara al hombro** y Shin una **pértiga con micrófono** (hoja 2 nº58). Y Nagumo, el más votado, **miente por costumbre**: actuar es su oficio | Oshi no Ko (05, asignado); lo proponen HxH (36), Blue Lock (42) y otras de reserva |
| C | **ıı・🪪・presentaciones** (EMPIEZA AQUÍ, foro) | «Tu ficha del servidor. Es opcional, pero es lo que hace que la gente te ponga cara. Abre TU hilo con la plantilla fijada…» | Portada a color del capítulo 45: todo el grupo en **fila de fichaje**, delante de la regla de alturas, cada uno con **su cartel con el nombre** (hoja 2 nº81). Es una ficha de presentación hecha por la serie | Spy×Family (06, asignado); lo proponen Mob (45) y Encanto (58) |

**Mi recomendación: la A.** El canal está libre. El objeto es real y de
la serie (una tablilla con pinza, que se hace en **Blender** con el papel
curvado). El sitio es real (la puerta de la tienda, con su bandera
«営業», hoja 1 nº15). Y el texto del canal habla de **estrenos,
temporadas y doblajes**: justo lo que hizo famosa a Sakamoto Days en
Latinoamérica.
...
|---|---|---|
| ıı・🏷️・ofertas-y-gratis | es una **tienda**: precios, rebajas, «los gratis caducan» | es de Bob Esponja (15), y su concepto A ya es **la caja registradora** del Crustáceo. Se repetiría el objeto |
| ıı・🎫・soporte | la caja registradora abre con un código el **almacén secreto**: «solo lo vemos tú y el staff» | es de Big Hero 6 (08). Y la caja, otra vez, es la idea de Bob Esponja |
| ıı・👋・bienvenidas | portada del capítulo 34: Sakamoto con delantal y el rótulo **«ようこそ 刺激的日常へ!!»** («¡bienvenidos a la vida diaria emocionante!», hoja 3 nº140) | es de One Piece (01). Queda como idea para una lámina 2 o un evento |
| ıı・📜・reglas | la regla nº1 de la familia: **no matar** | es de Attack on Titan (02) |
| ıı・🎯・reto-de-la-semana | el examen de ingreso a la **JCC**, la escuela de asesinos | muy pedido (Naruto 30, Kaguya 43, Intensamente 62…) y las partes no traen imágenes de la JCC |
| ıı・🧾・log-mod | la **Order** es la policía interna de los asesinos. La fila de fichaje del capítulo 45 sirve para «cada sanción, quién y por qué» | es privado (REGISTRO): lo ve poca gente. Queda como reserva del concepto C |
| ıı・📥・postulaciones | Shin entra a trabajar en la tienda por **1855 yenes la hora** (capítulo 1, pág. 52, según la wiki) | es privado; Haikyuu (34) ya lo usa con un formulario de inscripción |
| ıı・📺・que-estas-viendo | fue el anime más visto de Netflix en 2025 | es de Chainsaw Man (11) |
| ıı・🎮・a-que-juegas | el juego de móvil *Sakapazu* tiene su propia caja de diálogo (§13) | es de Cyberpunk Edgerunners (27); el juego sólo existe en Japón y no se pudo abrir |
| ıı・💬・general-doblaje | doblaje simultáneo; la anécdota del «¡Ay, caray!» de Óscar López | lo piden FMA (37) y Saint Seiya (39). La idea cabe dentro del concepto B |

---

## 1 · Resumen para quien tenga prisa

- **Qué es.** Manga de **Yuto Suzuki** en Weekly Shōnen Jump (desde
  noviembre de 2020). Anime de **TMS Entertainment** en Netflix, 22
  episodios en dos partes (11-ene a 22-mar y 15-jul a 23-sep de 2025).
  Comedia de acción: un asesino legendario se retira, se casa, engorda y
  abre una tienda de barrio. Los asesinos vienen a buscarlo y él pelea
  **sin matar**, porque se lo juró a su mujer.
- **El trío del encargo.** Tarō Sakamoto (gordo, lentes redondos,
  delantal verde), Shin Asakura (rubio, sudadera azul, **lee mentes**) y
  **Lu Shaotang** (pelo rosa, hace bollos de cerdo). Ojo: las partes de
  imagen y vídeo miraron por error a **Lu Wutang**, otro personaje (§28).
- **El más querido no es el protagonista.** Nagumo gana la 2ª encuesta
  oficial (28 478 votos) y Shin la 1ª. **Sakamoto cae al 8º puesto** (§9).
- **Cómo habla la serie.** Cartela **negra de esquinas redondeadas con
  letras amarillas** para los títulos (§7). El juego de móvil usa una
  caja negra `#1E1E1E` con **placa de nombre naranja** `#FECB00`.
  Onomatopeyas a pincel, sin caja. **Nunca** una burbuja blanca genérica.
- **Doblaje latino.** VSI México City. Sakamoto: **Óscar López**. Shin:
  **Geezuz González**. Lu: **Irene Ponce**. Nagumo: **Bruno Coronel**.
  Frase de cartel: «Decidí que ahora la utilizaré para proteger a los que
  amo. Eso es lo que me hace más fuerte» (tráiler, 1:19).
- **Colores.** Delantal verde `#2E664B`, camiseta mostaza `#E6B740`,
  sudadera de Shin `#3974B0`, gabardina de Nagumo `#DED0B3`. Sombra plana
  de un tono, con **textura de papel sólo en las sombras** (§19).
- **Letras libres** (todas con tildes, ñ, ¿ y ¡): **Anton** para el logo,
  **Bangers** para gritos, **Patrick Hand** para globos, **Caveat** para
  pensamientos (§6).
- **Lámina recomendada.** El *kairanban* de la tienda para
  **#noticias-anime**, con Shin y Sakamoto en la puerta (§27 A).

---

## 2 · Las escenas que sirven, con minuto

**Techo real: 720p.** El opening de Internet Archive llega a 1280×720. Los
clips de Dailymotion son de 512×288 de origen. No hubo 1080p sin iniciar
sesión en Netflix (y no se usa la cuenta del dueño). Para nitidez, mejor
las ilustraciones oficiales de §3.

| Escena | Vídeo | Minuto | Qué pasa | Estado |
|---|---|---|---|---|
| Shin suplica de rodillas | [Episodio 1, escena de la tienda](https://www.dailymotion.com/video/x9g89je) | 0:08 | Un grupo de asesinos entra a la tienda. Shin, de rodillas: «Please let Mr. Sakamoto live!» | ✅ (coincide con la sinopsis del ep. 1) |
| Shin apunta a dos manos | [Episodio 1](https://www.dailymotion.com/video/x9g89je) | 0:16 | Mirada fija. Un cómplice avisa: «If you get close, he'll read your mind» | ✅ |
| La armería a oscuras | [Episodio 1](https://www.dailymotion.com/video/x9g89je) | 0:32 | Pared de armas, una sola luz puntual | ✅ (paleta en §5) |
| Shin esquiva agachado | [Episodio 1](https://www.dailymotion.com/video/x9g89je) | 1:12 | Chispas y disparos alrededor | ✅ |
| La queja de las horas extra | [Episodio 1](https://www.dailymotion.com/video/x9g89je) | 1:52 | Sakamoto con delantal, sangre en el hombro, se queja con humor tras el tiroteo: «For overtime…» (subtítulo inglés) | ✅ (mirado dos veces) |
| Sakamoto serio | [Episodio 1](https://www.dailymotion.com/video/x9g89je) | 2:00 | Primer plano, cejas fruncidas tras los lentes: impone sin gritar | ✅ |
| Sakamoto y Shin al atardecer | [Opening 1](https://archive.org/details/sakamoto-days-op-1) | 1:25 | Dos siluetas caminan hacia el sol en un cruce: plano final del OP | ✅ (1280×720) |
| Shin tumbado sobre Sakamoto en el sofá | [Tráiler Netflix VOSTFR](https://www.dailymotion.com/video/x9c6rxi) | 0:15 | Gag doméstico en el salón | ✅ |
| Mesa de comida | [Tráiler Netflix VOSTFR](https://www.dailymotion.com/video/x9c6rxi) | 0:20 | El gag de que Sakamoto «engordó» | ✅ |
| Shin de brazos cruzados con delantal | [Tráiler Netflix VOSTFR](https://www.dailymotion.com/video/x9c6rxi) | 1:00 | Shin al mando del mostrador | ✅ |
| El abrazo | [Tráiler Netflix VOSTFR](https://www.dailymotion.com/video/x9c6rxi) | 1:15 | Sakamoto abraza a Shin, mano en la nuca. «Salut, Sakamoto» | ✅ |
| La tienda por dentro | [Tráiler Netflix VOSTFR](https://www.dailymotion.com/video/x9c6rxi) | 1:20 | Mostrador y estanterías con luz cálida de día | ✅ (paleta en §5) |
| Caída desde una torre | [Tráiler Parte 2](https://www.dailymotion.com/video/x9k1124) | 1:17 | Una silueta cae entre humo y escombros. «Un père doit se montrer ferme» | ⚠️ no se sabe quién cae |
| «No volveré a ser un asesino» | [Tráiler doblado al latino](https://www.dailymotion.com/video/x9a858e?t=22) | 0:22 | Sakamoto, serio, en la tienda | ✅ |
| Pulgar arriba | [Tráiler latino](https://www.dailymotion.com/video/x9a858e?t=27) | 0:27 | Orgullo tranquilo de Sakamoto; Shin con los ojos muy abiertos | ✅ |
| «A partir de ahora, voy a pelear en serio» | [Tráiler latino](https://www.dailymotion.com/video/x9a858e?t=58) | 0:58 | Shin, fondo en llamas | ✅ |
| Pánico al oír «¡divorcio!» | [Tráiler final (audio portugués)](https://www.dailymotion.com/video/x9c2low?t=74) | 1:14 | Sakamoto, boca abierta, ojos como platos | ✅ (sólo la cara; el audio no es latino) |

Datos útiles del **episodio 8** (min 20:10) y del **episodio 2** (min
10:00) están en §10: son líneas del doblaje que la propia Doblaje Wiki
señala por errores.
...
Las tres hojas de `hojas/` salen de la wiki de Fandom
([sakamoto-days.fandom.com](https://sakamoto-days.fandom.com/wiki/Taro_Sakamoto))
con `investigar_serie.py`: 144 imágenes numeradas, casi todas de más de
1000 px. El redactor las miró número a número. **Los números de abajo son
los de las hojas**, no los de `partes/imagen.md` (allí estaban
desplazados, §28).

### 3.1 Hojas de modelo del anime (fondo verde, pose neutra)

| Hoja · nº | Qué es | Tamaño | Para qué |
|---|---|---|---|
| 1 · 44 | **Sakamoto, 1ª parte**: gordo, pelo corto gris claro, lentes redondos, camiseta mostaza con parche rojo, pantalón azul grisáceo. Se agarra el hombro | 1075×1792 | vestuario y colores base ([imagen](https://static.wikia.nocookie.net/sakamoto-days/images/b/bf/Taro_Sakamoto_anime_design.png)) |
| 1 · 39 | **Sakamoto, «2nd Season»**: delantal verde sobre la camiseta, brazo extendido lanzando algo con un hilo | 1053×1986 | el uniforme de la tienda ([imagen](https://static.wikia.nocookie.net/sakamoto-days/images/4/43/Taro_Sakamoto_2nd_Season_anime_design.png)) |
| 1 · 35 | La wiki la titula «Taro Sakamoto 2nd Season»: figura delgada, pelo negro corto, lentes, traje azul marino y una vara larga al hombro | 1147×2112 | ⚠️ parece el Sakamoto joven o «prime»; confirmar a tamaño completo |
| 1 · 42 | **Shin, 1ª parte**: sudadera azul con capucha, pantalón ancho claro | 1093×1821 | ([imagen](https://static.wikia.nocookie.net/sakamoto-days/images/3/37/Shin_Asakura_anime_design.png)) |
| 1 · 37 | **Shin, «2nd Season»**: sudadera azul, **delantal verde** de la tienda, pistola en alto a una mano, zapatillas rojas y blancas | 1150×1884 | pose de acción ya hecha |
| 1 · 36 y 34 | **Nagumo**, 1ª parte y «2nd Season»: gabardina beige, camisa estampada | 1176×1960 y 1108×2255 | ([imagen](https://static.wikia.nocookie.net/sakamoto-days/images/2/22/Yoichi_Nagumo_anime_design.png)) |
| 1 · 43 y 17 | **Osaragi**, 1ª parte y «2nd Season»: vestido largo negro de encaje | 1091×1819 y 1357×2203 | ([imagen](https://static.wikia.nocookie.net/sakamoto-days/images/d/de/Osaragi_anime_design.png)) |
| 2 · 50 | **Lu Wutang** (no es la Lu del trío): chico alto, trenza negra, changshan lila | 1008×1680 | sólo si sale Wutang |
| 3 · 116 | Hoja de Shin con tres cabezas giradas | 842×1080 | giro de cabeza para Blender |

### 3.2 Ilustraciones con pose viva

| Hoja · nº | Qué es | Tamaño |
|---|---|---|
| 1 · 33 | **Shin en acción**: pistola en alto, sudadera azul, el delantal verde volando como capa. Trazo de rotulador y trama, no *cel* ([imagen](https://static.wikia.nocookie.net/sakamoto-days/images/a/ad/Shin_Asakura.png)) | 1600×1588 |
| 1 · 47 | **Nagumo**: gabardina, un dado en la palma abierta, su arma plegable detrás | 1066×1600 |
| 1 · 41 | **Osaragi** con la sierra plegable, salpicaduras rojas | 1491×1345 |
| 1 · 15 | Portada a color cap. 221: **Sakamoto leyendo el periódico** sentado en la puerta de la tienda, bandera **«営業»**, Shin agachado en los escalones. Rótulo vertical «守りたい かけがえのない 日常» («el día a día irremplazable que quiero proteger») | 2048×1498 |
| 2 · 58 | Portada a color cap. 168: **«祝・TV アニメ化決定!»**. Sakamoto con gorra roja y **cámara al hombro**, Shin con **pértiga y micrófono**, una chica de blanco como actriz | 1471×1080 |
| 2 · 81 | Portada a color cap. 45: **fila de fichaje** con la regla de alturas; cada uno sostiene un cartel con su nombre. Sakamoto al centro con delantal, Lu (pelo rosa) a la derecha. Rótulo **«日常と非日常»** | 1284×936 |
| 2 · 57 | Portada cap. 148: tres asesinos en un tren, uno lee el periódico. Rótulo **«日常発 戦場行き»** («sale de lo cotidiano, va al campo de batalla») | 1474×1080 |
| 2 · 71 | Portada cap. 18: **Lu Shaotang** (pelo rosa) en una moto con Sakamoto y Shin, ropa de playa. Rótulo «毎日をもっと好きになる。» | 959×1400 |
| 3 · 140 | Portada cap. 34: Sakamoto con delantal verde y camiseta amarilla, **«ようこそ 刺激的日常へ!!»** | 634×927 |
| 3 · 100 | **Teaser visual** del anime: Sakamoto con pistola, lentes que brillan, «その店長 元・伝説の殺し屋» («ese tendero, ex asesino legendario»), «2025 01 ON AIR» | 849×1200 |
| 2 · 80 | Manga: Sakamoto **para un autobús con un cartel** | 1270×955 |
| 1 · 31 | Manga: Sakamoto salva a Shin | 1918×1400 |

### 3.3 Portadas, tomos y fichas

- **44 portadas de Weekly Shōnen Jump** con la serie en cabecera
  (2020-2026), hasta 2083×2993. Ejemplos: hoja 1 nº3-7, nº18 (anuncio del
  anime, 2024), nº40 (anuncio de la película). ✅
- **Tomos**: hoja 3 nº111 (tomo 1: Sakamoto con delantal y pistola),
  nº112 (tomo 2), nº113, 114, 110 y 115 (tomos 3 a 6); hoja 1 nº11
  (tomo 20), nº32 (tomo 9); hoja 2 nº52 (tomo 23), nº61 (tomo 16). La portada del
  tomo 1 también está en
  [Wikimedia](https://upload.wikimedia.org/wikipedia/commons/4/47/Sakamoto_Days_volume_1.png)
  (764×1200). ⚠️ Allí figura como «CC BY-SA 4.0, autor Yuto Suzuki»: es
  raro para una portada comercial. Tratarla como © Shueisha.
- **Blu-ray** vol. 1-4 (hoja 3 nº120, 136, 137, 135): fondo de color
  plano, personaje en negro y un solo tono. 717-800 px de ancho. ✅
- **Fichas «Character Profile»**: página en blanco y negro con cabecera
  **«坂本商店回覧板 さかてい!»** (el *kairanban*, la tablilla de avisos de
  la tienda) y «坂本商店㊙キャラクターノート!!». Hoja 2 nº65 (Sakamoto),
  nº64 (Shin), nº59; hoja 1 nº46 (Nagumo). 960×1400 a 1080×1582. ✅ visto
- **Spin-off «Sakamoto Holidays»**: portadas propias, más infantiles
  (hoja 1 nº14, nº45; hoja 2 nº79, nº86; hoja 3 nº99). ✅
- **Anime, portada y banner** de
  [AniList](https://anilist.co/anime/177709):
  [portada](https://s4.anilist.co/file/anilistcdn/media/anime/cover/large/bx177709-e5Qx6RlsBgD5.png)
  y [banner](https://s4.anilist.co/file/anilistcdn/media/anime/banner/177709-yeZ7ciQULJRx.jpg). ✅
- **Key art de grupo en 4K** (Sakamoto, Shin, Nagumo):
  [4096×2990 en Alphacoders](https://images5.alphacoders.com/138/1383153.jpg),
  el mismo archivo que en Wallhaven. ✅
- **Arte exclusivo del juego de móvil** *Sakapazu*: existe, pero no se
  pudo abrir el juego para verlo (§13). ⚠️
- **Web oficial**: [sakamotodays.jp](https://sakamotodays.jp/) y la cuenta
  [@SAKAMOTODAYS_PR](https://twitter.com/SAKAMOTODAYS_PR) (de la ficha de
