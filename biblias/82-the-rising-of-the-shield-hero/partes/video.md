...
- **Ambiente sonoro por escena** (visto, no sólo oído): la Ola de la Catástrofe (ep.3, 11:00-15:00) tiene el cielo teñido de rojo sangre con anillos morados que se abren (portales) — el tono es de alarma/apocalipsis. La escena de la curación de Raphtalia en la fuente (ep.2, 21:00-21:30) usa luz turquesa/verde-azulada de abajo hacia arriba, tono íntimo.
- **Tema de la escena más emotiva de la Temporada 1: "Falling Through Starlight"** (episodio 4, cuando Raphtalia enfrenta y supera su trauma con las bestias que mataron a sus padres y Naofumi la consuela) · ✅ **confirmado en dos fuentes**: Anime News Network (`animenewsnetwork.com/interest/2019-01-31/...`, anuncio de que el doblaje en inglés tendría una versión alternativa de este tema de inserción) y la cuenta oficial de X/Twitter `@ShieldHeroEN` (créditos completos: compuesta por **Kevin Penkin**, versión japonesa cantada por **Asami Seto** —voz de Raphtalia— y versión en inglés por **Amelia Jones**). Aparece también como pista **18 "Raphtalia"** (instrumental) y pistas 22/25 "Falling Through Starlight" (ft. Amelia Jones / ft. Asami Seto) en el álbum oficial *The Rising of the Shield Hero Original Soundtrack "Dusk"* (COCX-40782, Kevin Penkin, 2019) listado en VGMdb (`vgmdb.net/album/84770`) y en HMV Japón · ✅ (VGMdb + HMV, dos fuentes de la ficha del disco).
  - Tracklist completo de "Dusk" (para cruzar con otras escenas emotivas o de tensión): *The Rising of the Shield Hero, Sunshine with Shields, Resonance of Churchs, H.U.D., Moonlight, Campbell 1-1, Parliament, Fermentation, Core-collapse, Apocalypse, Kansas, Beloukas, Catch Me, Cartwheel, Contrabass, Mirrors, Crystalline, Raphtalia, WAVES, Autoroll, GAMESTART, Falling Through Starlight (ft. Amelia Jones), Lifeblood, Three Heros Church, Falling Through Starlight (ft. Asami Seto)* · ✅ (VGMdb/HMV). Otros álbumes oficiales de la banda sonora confirmados en VGMdb: *"Dawn"* (COCX-40888~9, T1 vol.2), *"Twilight"* (COCX-41792~3, T2) y *"Moonlit"* (COCX-42454, T3) — no llegué a leer sus tracklists completos por cupo; quedan para quien continúe con el punto 9 de temporadas posteriores.
...
- **Tendencias de TikTok/YouTube**: no encontré un reto o sonido único y coordinado (no es una serie de "trend" de baile como otras), sino actividad de fans dispersa y constante · ✅ (confirmado por las páginas de descubrimiento de TikTok, dos búsquedas independientes): hashtags activos `#shieldhero`, `#therisingoftheshieldhero`, `#raphtalia`, `#naofumi` con ediciones (*edits*) de escenas Naofumi/Raphtalia con música de fondo variada (sonidos propios de cada creador, no un audio viral único), vídeos de cosplay (p. ej. `@westonmac_tiktok`, escenas "Naofumi missing Raphtalia in season 2"), y contenido tipo "momento canon Naofumi x Raphtalia" con miles de vistas. El pico de actividad coincide con el estreno de la Temporada 4 (julio-septiembre de 2025). **No hay una tendencia única con minuto exacto que citar** (son cientos de ediciones cortas, no un vídeo de referencia); lo que sí es constante y repetido en las etiquetas es la pareja Naofumi/Raphtalia como el contenido más compartido, útil para el punto 21 (por qué la gente la ama) y el 7 (dinámicas entre personajes).
