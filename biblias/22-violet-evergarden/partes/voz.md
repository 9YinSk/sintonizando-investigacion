# Parte de VOZ Y PERSONAJES · Violet Evergarden (puntos 7, 8, 12, 13, 20, 21, 22)

Investigador de voz y personajes, método `serie-en-equipo`. Parto de
`partes/datos-voz.md` (no repito esas consultas) y de la `biblia.md` vieja
(hecha con la red cerrada): la uso como pista, pero **verifico todo de nuevo**
con la red abierta antes de darlo por bueno. Trabajo pesado en
`/tmp/claude-0/trabajo/22-violet-voz`.

## Hallazgos

### 7 · Popularidad (encuestas oficiales y de fans)

- **Encuesta de fans ねとらぼ (nlab.itmedia.co.jp), 2021**: 6292 votos
  (17-jun-2021). 1) **Violet Evergarden** 3382 votos (53,8 %); 2) **Claudia
  Hodgins** 565; 3) **Benedict Blue** 550; 4) Gilbert Bougainvillea 455;
  5) Dietfried Bougainvillea 358; 6) Ann Magnolia 201; 7) Cattleya
  Baudelaire 131; 8) Charlotte Abelfreyja Drossel 95; 9) Iris Cannary 92;
  10) Luculia Marlborough 81 · ✅ (artículo:
  [nlab 240645](https://nlab.itmedia.co.jp/research/articles/240645/)).
- **Encuesta de fans ねとらぼ, 2022** (15 al 22-abr-2022, 2310 votos): 1)
  Violet Evergarden 1120 votos (48,4 %); 2) **Benedict Blue** 298 votos
  (12,9 %) · ✅ (artículo:
  [nlab 694099](https://nlab.itmedia.co.jp/research/articles/694099/); el
  top 3-23 completo está en las páginas 2-6 del mismo artículo, no las
  pude abrir todas: lo que sigue en ⚠️ es de fuentes de fans, no de este
  ranking).
- **Dos encuestas independientes (2021 y 2022) coinciden**: tras Violet,
  el más querido es **Benedict Blue** (secundario, el cartero) — encaja
  con lo que pide el dueño («quizá un personaje secundario es más
  querido que el principal») ✅✅.
- **No encontré una encuesta oficial** de Kyoto Animation o de la
  editorial (Kadokawa/KA Esuma Bunko): sólo la de ねとらぼ (medio de
  noticias, pero la encuesta la vota el público, no es oficial del
  estudio). Búsquedas: «ヴァイオレット・エヴァーガーデン 公式 人気投票»,
  «Violet Evergarden official popularity poll Dengeki Da Vinci».
- **Danbooru (cariño del fandom por cuánto dibujan a cada uno)**: la
  tabla de `datos-voz.md` está **mal** (mezcla personajes de otras
  series: es un fallo de la consulta automática, no de Violet
  Evergarden). Los conté yo mismo por personaje con la API de conteo
  (`counts/posts.json?tags=<tag>`) el 24-sep-2026 ✅:
  Violet (`violet_evergarden_(character)`) 1214 posts · Gilbert
  Bougainvillea 57 · Cattleya Baudelaire 34 · Iris Cannary 19 · Erica
  Brown 19 · Claudia Hodgins 17 · Benedict Blue 13. Incluso en fan art,
  **Violet arrasa** y **Gilbert es el segundo** más dibujado (no
  Benedict): la popularidad de Benedict es de **encuesta de texto**, la
  de Gilbert es de **imagen** — dos formas de querer a un personaje.
- Ranking de fans en [ranking.net](https://ranking.net/rankings/best-violet-evergarden-characters)
  (23 posiciones, sin fecha ni número de votos) ⚠️: coincide en que
  Violet es 1.º; no cuenta como confirmación por no dar metodología.

### 8 · Doblaje latino y frases textuales

**Ficha general** (confirmada en Doblaje Wiki más ANMTV) ✅: estudio
**SDI Media de México** (luego Iyuno-SDI Group); dirección **Carla
Castañeda**; traductora Mireya Mendoza; año de grabación 2017; estreno
en Netflix Latinoamérica el **11-ene-2018** (México y EE. UU. el
5-abr-2018) — fuentes:
[Doblaje Wiki](https://doblaje.fandom.com/es/wiki/Violet_Evergarden),
[ANMTV, ene-2018](https://www.anmtvla.com/2018/01/exclusiva-filtrado-video-latino-de.html)
(confirma que hubo doblaje latino filtrado antes del estreno, sin
detalle de reparto en el cuerpo del artículo).

**Reparto por personaje**, con **minuto exacto** de la muestra oficial
de Doblaje Wiki «[Violet Evergarden | Voces del doblaje
latino](https://www.youtube.com/watch?v=wEgiayIdKR4)» (su locución
recorre uno a uno los personajes; los tiempos están en la ficha de la
«Muestra multimedia» de la wiki, wikitext de
`Archivo:Violet_Evergarden_-_Voces_del_doblaje_latino`) — cada nombre
además está en la tabla de reparto de la página principal de Doblaje
Wiki: **dos fuentes** ✅:

| Minuto en la muestra | Personaje | Voz latina |
|---|---|---|
| 0:00 | Violet Evergarden | **Andrea Arruti** |
| 0:20 | Erica Brown | Alondra Hidalgo |
| 0:38 | Iris Cannary | Andrea Orozco |
| 0:50 | Cattleya Baudelaire | **Carla Castañeda** (también dirige) |
| 1:04 | Claudia Hodgins | **Carlos Hernández** |
| 1:17 | Benedict Blue | Alan Fernando Velázquez |
| 1:31 | Gilbert Bougainvillea | Alejandro Orozco |
| 1:48 | Dietfried Bougainvillea | Irwin Daayán |
| 2:03 | Luculia Marlborough | Lourdes Arruti |
| 2:21 | Roland | Pedro D'Aguillón Jr. |
| 2:35 | Merkulov | Jorge Badillo |
| 2:47 | Bluebell Unoa | Erika Langarica |
| 2:58 | Iberis Conoway | Analiz Sánchez |
...
Con esto **queda llena** la tabla de `datos-voz.md` (que tenía la
columna «Personaje» vacía): cada actor de esa tabla es el de arriba.

**Cambios de voz dentro de la serie** (dato que no estaba) ✅
(wikitext de la página principal, Doblaje Wiki):
- Varios *loops* de Gilbert los dobla **Mauricio Pérez**, no siempre
  Alejandro Orozco.
- En el episodio 4, varios *loops* de Iris los dobla **Erika Langarica**
  (la voz oficial de Bluebell Unoa), no siempre Andrea Orozco.
- **Humberto Solórzano** dobla al rey de la obra «El Rey Rojo» dentro
  del episodio 7 (personaje de un solo capítulo).
- En el **episodio 10**, el loop de Violet lo dobla **Nycolle González**,
  no Andrea Arruti: según contó la propia González, Arruti sí grabó sus
  líneas pero la productora no las usó y pidió a González que las
  regrabara, sin avisar a Arruti ✅ (wikitext de Doblaje Wiki, que cita
  [un vídeo de González explicándolo](https://www.youtube.com/watch?v=XNwdgCWarRk)).

**Andrea Arruti (1998-2020), la voz de Violet** ✅ (dos fuentes ya
verificadas en el equipo anterior: Doblaje Wiki y
[Código Espagueti](https://codigoespagueti.com/noticias/cultura/fallecio-andrea-arruti-la-voz-latina-de-violet-evergarden-y-neeko-en-league-of-legends/);
sumo una tercera, la ficha de actriz de Doblaje Wiki: nació el
1-jul-1998 en Ciudad de México, murió el 1-ene-2020 por un edema
pulmonar, 13 años en el doblaje (2006-2019). Fue **primera voz de
Violet** en la serie y el especial (2018-2020); tras su muerte,
**Nycolle González** la dobla desde el Gaiden (2020) y la película
(2021) — confirmado también por
[ANMTV, mar-2020](https://www.anmtvla.com/2020/03/violet-evergarden-eternity-and-auto_22.html):
«la actriz de voz será reemplazada [por] Nycolle González, quien ya
había interpretado al personaje en un loop del décimo episodio». Con
ANMTV son **tres fuentes** ✅✅✅ para Nycolle González.
- En un [tweet de Carla Castañeda](https://x.com/DubbCarlaCM/status/1078451023507800068/photo/1),
  directora de doblaje, cuenta que Andrea Arruti ayudó a los demás
  actores con la pronunciación correcta de palabras alemanas de la
  serie (los nombres como «Leidenschaftlich») ✅.

**Frases textuales del doblaje** ⚠️ **no lo conseguí, y digo por qué**:
YouTube (donde están los clips oficiales doblados, p. ej. «Violet y
Gilbert confesión - Doblaje Latino Oficial»,
https://www.youtube.com/watch?v=7ZtkUmEUQSM, 3:33 min) pide iniciar
sesión desde este servidor (`Sign in to confirm you're not a bot`) tanto
para bajar vídeo como subtítulos; lo probé con `yt-dlp` tres veces en
tres clips distintos y falla igual. **Plan B, Dailymotion**: transcribí
con `voz.py` (Whisper) el tráiler de 1:28 min
([x7t0he2](https://www.dailymotion.com/video/x7t0he2), FilmAffinity) y
tiene diálogo doblado real y claro («aquellos que sabían de su
existencia decían que era un arma, pero era sólo un instrumento
carente de alma», 0:08; «la guerra ha terminado, Violet» / «soy la
herramienta del comandante… si él ya no me necesita, deberían
deshacerse de mí», 0:39 a 0:49; «vive y sé libre», 0:57) — **pero por
el «coger las cartas» (0:24) y ser FilmAffinity (medio de España) esto
suena a **doblaje de España, no latino**: no lo uso como frase latina,
sólo como referencia de qué se dice en esa escena. El tráiler de
Netflix de la película ([x84a6nt](https://www.dailymotion.com/video/x84a6nt))
lo transcribí también, pero Whisper lo alucinó (salió texto sin
sentido: probablemente el audio real es japonés con subtítulo en
pantalla, no doblaje): **no lo uso**.
- Seguí las pistas del especial doblado en Netflix
  ([Doblaje Wiki, Especial](https://doblaje.fandom.com/es/wiki/Violet_Evergarden:_Especial))
  y la nota de
  [Bubbleblabber LATAM sobre «Recuerdos»](https://bubbleblabberespanol.com/2022/12/el-doblaje-de-el-especial-de-violet-evergarden-llega-a-netflix/):
  confirman que existe doblaje, no traen frases citadas.
- El saludo de Violet en japonés («お客様がお望みなら どこでも駆けつけます»)
  y su traducción al inglés oficial de la wiki («If it is your wish, I
  will travel anywhere to meet your request. Auto Memory Doll Violet
  Evergarden, at your service», ficha de
  [Violet Evergarden (anime character)](https://violet-evergarden.fandom.com/wiki/Violet_Evergarden_(anime_character)))
  dan el **sentido** exacto de la frase que hay que oír en español
  latino, pero **no la frase tal cual la dice el doblaje**: falta
  escucharla en Netflix o Crunchyroll (con cuenta), cosa que este
  servidor no permite. Dejo la pista para quien redacte o revise con
  acceso a Netflix.
- **Un dato del fandom hispano sobre el doblaje** (sirve para el punto
  22 también): hay un reto de doblaje de fans en TikTok que usa
  precisamente el discurso del primer episodio de Violet como prueba de
...
abierta) ✅:
- **La máquina de escribir** y las manos de metal tecleando: es la
  imagen de portada de casi todo fan art y el gif más compartido
  (TikTok «Violet Evergarden Typewriter», Tenor «violet-evergarden-typing»).
  La escena de Violet tecleando **tardó 3 meses en animarse** sólo esa
  toma ✅ (citado en varias notas de producción, confirmado por el
  resumen de Know Your Meme).
- **«Te quiero» / "I love you"**: la pregunta que mueve toda la serie;
  es el gancho que más se repite en TikTok y reseñas.
- **El ep. 10** (las cartas de la madre para Ann) es **el tearjerker**
  más citado de la serie: Violet aguanta las lágrimas toda la semana
  que pasa con la familia y se rompe después, con sus compañeros,
  diciendo que Ann se quedará sola cuando su madre muera ✅
  ([TV Tropes, vía caché de búsqueda](https://tvtropes.org/pmwiki/pmwiki.php/TearJerker/VioletEvergarden);
  [Xenodude Scribbles, reseña](https://xenodude.com/2018/03/17/violet-evergarden-ep-10/)).
  TV Tropes en directo me dio **403** (bloqueado para este servidor);
  uso el resumen que devolvió el buscador con la página como fuente.
- El saludo **«Encantada… acudiré… Violet Evergarden»** (repetido en
  eps. 4, 5, 6, 7, 10 y 13) es la frase que más citan los fans al hacer
  cosplay o vídeos de presentación ✅ (ya contado en subtítulos por el
  equipo anterior).
- **Datos de recepción** (nuevos, para «por qué la aman» también):
  **8,52/10 en MyAnimeList** (+27 000 votos) y **8,6/10 en IMDb**; el
  subreddit r/VioletEvergarden pasa de 990 suscriptores ✅ (Know Your
  Meme, resumen del 24-sep-2026).
- El humor de oficina (Hodgins y los tres muñecos, Cattleya y Benedict
  peleando y luego tomando el té) sigue confirmado por TV Tropes/Funny
  (ya visto en el repaso anterior).

**Un tema delicado: el incendio de Kyoto Animation** (confirmado, sigue
igual que antes) ✅: el 18-jul-2019 murieron 36 personas en un ataque al
Estudio 1; el Gaiden puso los nombres de las víctimas en los créditos.
**Nunca** usar fuego/humo como adorno en la lámina.

**Qué NO hacer** (igual que antes, con una cosa nueva) ✅:
- Nada de burbuja blanca: el diálogo es una carta escrita a máquina.
- Manos de carne: son de metal, con guantes marrones encima.
- Máquina de escribir moderna o gris de oficina: la suya es pequeña,
  portátil, de cuatro filas de teclas redondas, estilo años 20, y viaja
  en su maleta.
- Violet sonriendo de oreja a oreja o en pose «kawaii»: es seria y
  contenida; cuando sonríe, es una sonrisa pequeña y tardía (§13).
- Colores chillones o neón: la paleta es luz dorada, crema, azul, verde.
- Chistes sobre sus brazos, la guerra o el incendio de Kioto Animation.
- Dar por hecho o hacer broma con la historia de amor de Gilbert.
- **Nuevo**: no poner a Violet enojada «a gritos» — la serie casi no
  tiene escenas de Violet furiosa (busqué «Violet angry», «Violet
  scared» en el buscador de imágenes de la wiki y no hay ninguna
  etiquetada así; sí hay «Iris angry» y «Angry Cattleya», ver §13): su
  registro de enfado es **quietud tensa**, no gritos ni gestos grandes.
  Ponerle una cara de furia genérica de anime sería falso al personaje.
