...
serie: "Hunter x Hunter (HUNTER×HUNTER, ハンター×ハンター)"
canal: "sin canal: propuesta #castings (choca con Oshi no Ko, 05); libre: #postulaciones; reserva: 🎲 Juegos (ver §0)"
fecha: 2026-09-25
---

# Biblia · Hunter x Hunter — para la biblioteca

> [!important] Cómo se hizo, y sus límites
> - La escribió el **redactor** con las cuatro partes del equipo
>   (`partes/imagen.md`, `video.md`, `voz.md`, `texto.md`) y las fichas de
>   `partes/episodios.md`. Nada nuevo sin fuente.
> - Se trabaja sobre el **anime de 2011 (Madhouse, 148 episodios)**: es la
>   adaptación completa y la que tiene el doblaje latino que hoy está en
>   Netflix. El de 1999 (Nippon Animation, 62 episodios, en latino «Cazador X»)
>   se cita cuando cambia algo.
> - **YouTube pidió «confirma que no eres un bot».** Los vídeos se miraron en
>   **Dailymotion** (tráiler oficial de VIZ y clips) y en **Internet Archive**
>   (opening y ending sin créditos en BD 1280×720, episodios 131 y 147 en
>   720p). El minuto que doy es **el del vídeo enlazado**.
> - **AnimeThemes estaba caído** (error 522) todo el día.
> - **Frases del doblaje latino**: salen de un clip de **Cazador X (1999)**
>   transcrito con `voz.py`. Del doblaje de 2011 no hay clip doblado que se
>   pudiera bajar (§10.3).
> - El redactor **miró las hojas de contacto del tráiler, del opening, del
>   ending y del clip de Hisoka** para resolver choques entre partes. Tres
>   datos de las partes estaban mal y se corrigen aquí (§28).
> - ✅ = dos fuentes o visto por nosotros. ⚠️ = una sola fuente. Lo que no se
...
0. Hunter x Hunter no tiene canal: dónde encaja mejor
...
6. Tipografía: una letra para cada uso, y el alfabeto Hunter [5]
...
La serie empieza con un **examen**: cientos de aspirantes, cada uno con una
**placa numerada** en el pecho, pruebas que eliminan a casi todos y, al
final, una **Licencia de Cazador** para quien pasa. Eso es, casi palabra por
palabra, lo que pasa en un casting o en una postulación.

| Canal | Qué dice el inventario | Por qué encaja | Choque |
|---|---|---|---|
| **#castings** (foro, EL ESTUDIO) — **la mejor** | «Cada casting es un hilo. Ciérralo cuando el papel esté cubierto.» Etiquetas: Anime, Videojuego, Serie, Película, Corto, Comercial, Audiolibro, Pagado, Sin paga, Abierto, Cerrado, Urgente, Oficial del servidor, Canto, +18 | El Examen Hunter *es* una audición: placa con número (Gon 405, Hisoka 44, Kurapika 404, Killua 99), pruebas, pocos aprobados. «Cerrado» = la licencia entregada | **Sí**: el encargo 05 (Oshi no Ko) nombra #castings entre sus tres canales. Decide el dueño |
| **#postulaciones** (texto, PRIVADOS) — libre | «Solicitudes de staff y de proyectos.» | Postularse al staff = presentarse al Examen. Netero, presidente de la Asociación, puede dar la licencia a quien quiera (AniList) | Ninguno: nadie lo pidió |
| **🎲 Juegos** (voz, EN VIVO) — reserva | sala de voz, sin texto | El arco de **Greed Island** es un videojuego dentro de la serie: libro con casillas y cartas | **Sí**: Ralph (29) y One Punch Man (35) |

**Propuesta:** **#castings** con el Examen Hunter (concepto A, §27). Si el
dueño deja #castings a Oshi no Ko, **#postulaciones** está libre y usa el
mismo mundo (concepto B). El concepto C (Greed Island) sirve para 🎲 Juegos.

## 1 · Resumen para quien tenga prisa

- **Qué es**: manga de Yoshihiro Togashi (Weekly Shōnen Jump). Gon, un niño de
  isla, se presenta al **Examen Hunter** para encontrar a su padre. Hace
  amigos: Killua (hijo de asesinos), Kurapika (último de su clan) y Leorio
  (quiere ser médico). Poderes con reglas: el **Nen**.
- **El más querido**: **Killua**, ganó las **tres** encuestas oficiales de
  Jump (Gon siempre fue 3.º). En una encuesta reciente de Animate Times gana
  **Kurapika**, y dos villanos, **Illumi** y **Chrollo**, quedan por encima
  de Gon (§9).
- **Objeto real de la serie**: la **Licencia de Cazador** (tarjeta con rombo
  rojo sobre negro, `#B4181E`), la **placa numerada** del examen, las **cartas
  de Greed Island**, la caña de pescar de Gon, las cadenas de Kurapika.
- **Letra propia**: la serie tiene un **alfabeto Hunter** inventado (un signo
  por cada sílaba japonesa), y todos los títulos usan el signo **«×»**:
  «Departure × And × Friends» (§6).
- **Cuadro de diálogo**: no hay burbuja genérica. Lo propio es la **tarjeta
  de rótulo del tráiler** (letra con serifa clara sobre un mapa viejo con
  signos del alfabeto Hunter) y la **carta de Greed Island** (marco rojo, nivel,
  rango y caja de texto) (§7).
- **Colores**: verde de Gon `#3F8632`, morado de Killua `#706684`, azul
  marino de Kurapika `#282B57`, de Leorio `#03264F`, rojo de Hisoka `#C83A57`
  (§16).
- **Doblaje latino**: dos. **Cazador X** (Colombia, 1999: Gon y Killua con
  voz de hombre) y el de **2011** (México, MCS, dir. Gabriel Ortiz: Gon
  **Susana Moreno**, Killua **Verania Ortiz**, Hisoka **Gerardo Reyero** con
  acento francés) (§10).
- **Tono**: aventura luminosa al principio (Isla Ballena, cielo azul) que se
  oscurece mucho (Hormigas Quimera: rojo sangre `#552723`). No mezclar tonos
  de arcos distintos en una lámina (§14).

## 2 · Las escenas que sirven, con minuto

Todas miradas con `fotogramas.py` (1280×720). El minuto es del vídeo enlazado.

### 2.1 Tráiler oficial VIZ (Blu-ray Set 1, episodios 1-13) — 95 s, 63 planos

https://www.dailymotion.com/video/x8hzbhf · ✅ oficial (tarjeta final con el
logo de VIZ). Visto por el redactor en las dos hojas de contacto.

| Minuto | Qué se ve | Para qué |
|---|---|---|
...
| [0:47](https://www.dailymotion.com/video/x8hzbhf?t=47) | Kurapika con su **placa 404** en el pecho | la placa numerada |
...
### 2.2 La Ira de Gon — episodio 131 «Anger × And × Light» (イカリ×ト×ヒカリ)

La escena más citada del fandom. Arco Hormiga Quimera, emitido el 28-may-2014.
Ficha del episodio: https://hunterxhunter.fandom.com/wiki/Episode_131_(2011) ✅.
Clip de 56 s: https://www.dailymotion.com/video/x4jib2p · ✅ (17 planos).

- [0:00](https://www.dailymotion.com/video/x4jib2p?t=0) Killua entra corriendo al claro; el cuerpo de Neferpitou arde entre rocas doradas.
- [0:11](https://www.dailymotion.com/video/x4jib2p?t=11) Gon transformado (adulto, pelo largo) tendido en luz dorada.
- [0:21](https://www.dailymotion.com/video/x4jib2p?t=21) explosión de aura roja-naranja que cubre el bosque; Killua grita «Gon!».
- [0:29](https://www.dailymotion.com/video/x4jib2p?t=29) Killua en primer plano: ojos muy abiertos, boca abierta.
- [0:42](https://www.dailymotion.com/video/x4jib2p?t=42) Gon de lado, otra vez niño, con la luz del fuego encima: cara vacía.
- [0:46](https://www.dailymotion.com/video/x4jib2p?t=46) el bosque de noche desde lejos, con una luz blanca en el centro.
- **Episodio entero** (720p, Internet Archive) en `partes/episodios.md`,
  audio japonés con Whisper (⚠️ revisar nombres): [5:00](https://archive.org/download/OKanimeHunterXHunter131720pUlquiorraCifer/%5BOKanime%5D%20Hunter%20x%20Hunter%20-%20131%20%5B720p%5D%5BUlquiorra%20Cifer%5D.mp4?t=300)
  Pitou: «ゴン、残念だけど、君を殺さなきゃいけない。王のため。» («Gon, lo
  siento, pero tengo que matarte. Por el Rey»); [14:00](https://archive.org/download/OKanimeHunterXHunter131720pUlquiorraCifer/%5BOKanime%5D%20Hunter%20x%20Hunter%20-%20131%20%5B720p%5D%5BUlquiorra%20Cifer%5D.mp4?t=840)
  el narrador: «二度と念能力が使えなくなってもいい» (aunque nunca más pueda usar
  Nen); [17:00](https://archive.org/download/OKanimeHunterXHunter131720pUlquiorraCifer/%5BOKanime%5D%20Hunter%20x%20Hunter%20-%20131%20%5B720p%5D%5BUlquiorra%20Cifer%5D.mp4?t=1020)
  Killua piensa en Bisky y ve que lo de Gon es lo contrario.

### 2.3 Kurapika contra Uvogin — arco Yorknew

Clip de 283 s: https://www.dailymotion.com/video/x816c25 · ✅ (101 planos,
subtítulos en inglés).

- [0:45](https://www.dailymotion.com/video/x816c25?t=45) Kurapika de mayordomo, recto, en el vestíbulo.
- [0:48](https://www.dailymotion.com/video/x816c25?t=48) acantilados de noche con luna roja.
- [1:08](https://www.dailymotion.com/video/x816c25?t=68) la **Cadena de Juicio** enrollada en el brazo: «Strike first to win!».
- [2:51](https://www.dailymotion.com/video/x816c25?t=171) ojos escarlata; en pantalla el kanji **「変」** sobre negro: «I wield full control over every category of Nen».
- [3:09](https://www.dailymotion.com/video/x816c25?t=189) herido, lanza la cadena: «Tell me everything you know».
- [3:59](https://www.dailymotion.com/video/x816c25?t=239) sangre en la boca: «How can you do these things, yet feel and think nothing at all? Answer me!».

### 2.4 Hisoka contra Kastro — Arena Celestial

Clip: https://www.dailymotion.com/video/x816bz2 · ✅. Visto por el redactor.

- [0:00](https://www.dailymotion.com/video/x816bz2?t=0) el **puño del árbitro** (no de Hisoka) con el subtítulo «Begin!».
- [0:10](https://www.dailymotion.com/video/x816bz2?t=10) Killua en el público, boca abierta de sorpresa.
- [0:12](https://www.dailymotion.com/video/x816bz2?t=12) Hisoka corriendo, brazo adelante, la estrella en la mejilla.
- [0:28](https://www.dailymotion.com/video/x816bz2?t=28) el ring iluminado por un foco en un estadio oscuro.
- [0:37](https://www.dailymotion.com/video/x816bz2?t=37) primerísimo plano: estrella amarilla y lágrima rosa.
- [1:04](https://www.dailymotion.com/video/x816bz2?t=64) mano con aura verde (Bungee Gum): «then so be it.».
- [1:16](https://www.dailymotion.com/video/x816bz2?t=76) Hisoka sonriendo con el puño delante: «Go ahead and take it.».
- [1:33](https://www.dailymotion.com/video/x816bz2?t=93) sonrisa de lado con las marcas de la cara.

### 2.5 Otros momentos (episodio 147, 720p)

Ficha completa en `partes/episodios.md` (⚠️ audio con Whisper).
- [12:00](https://archive.org/download/3asqTeamHunterXHunter147720pHi10bitsDBE35235Metalghost/%5B3asq-Team%5D-Hunter-X-Hunter-147-%5B720p-Hi10bits%5D%5BDBE35235%5D_metalghost_.mp4?t=720)
  Gon visita a Kite: «次は俺がカイトを守るよ» («la próxima vez te protejo yo, Kite»).
- [16:00](https://archive.org/download/3asqTeamHunterXHunter147720pHi10bitsDBE35235Metalghost/%5B3asq-Team%5D-Hunter-X-Hunter-147-%5B720p-Hi10bits%5D%5BDBE35235%5D_metalghost_.mp4?t=960)
  el **Árbol del Mundo**: una guía dice que mide **1784 m**; hasta 500 m hay
  ascensor, «de ahí en adelante, te juegas la vida».
- [17:00](https://archive.org/download/3asqTeamHunterXHunter147720pHi10bitsDBE35235Metalghost/%5B3asq-Team%5D-Hunter-X-Hunter-147-%5B720p-Hi10bits%5D%5BDBE35235%5D_metalghost_.mp4?t=1020)
  a [20:00](https://archive.org/download/3asqTeamHunterXHunter147720pHi10bitsDBE35235Metalghost/%5B3asq-Team%5D-Hunter-X-Hunter-147-%5B720p-Hi10bits%5D%5BDBE35235%5D_metalghost_.mp4?t=1200)
  **Gon y Killua se separan** al pie del árbol; Killua se va con su hermana
  Alluka: «頼りにしてるぜ» («cuento contigo»).
- El episodio 1 también se pasó por `episodio.py`, pero su transcripción
  salió **ilegible** (mezcla de idiomas): no se cita. ⚠️

## 3 · Arte oficial y hojas de contacto

### 3.1 Las 3 hojas (`hojas/`) y qué número sirve

Las hizo el recolector con imágenes de la wiki; las miraron el investigador de
imagen y el redactor. Se conservan: son buenas y variadas.

**`hojas/personajes_01.jpg`** (35 piezas, 984 KB)
- **#1** portada del libro oficial *Characters Book World × Character ×
  Blessing* (3400×4898): Kurapika, Killua, Gon, Leorio.
- **#2** Blu-ray «Hunter Exam & Zoldyck» (2370×3195): Gon con la caña, Killua
  con la patineta, los 4 juntos.
- **#3** póster del arco Hormiga Quimera (3200×4078) · **#4** póster del
  Examen Hunter (2720×1816): todo el reparto amontonado, muy vivo.
- **#5** película *The Last Mission* (2013), diseños y póster.
- **#6** colaboración **Zoff** (3838×3496): los 6 de cuerpo entero con gafas
  · **#7** visual de Zoff (2660×1240): bustos con gafas.
- **#8-#10** tapas de *Omnibus Treasure* (fucsia, verde lima, rojo) con
  iconos y el nombre de cada personaje en letra de molde.
- **#11-#12** calendario oficial 2014.
- **#13** Gon en *Jump Force* (3D, 3500×3500) · **#14** Kurapika en *Jump
  Force*, de traje · **#15** visual oficial de *Nen × Impact* (Gon y Killua).
- **#16** Bisky en *Nen × Impact*.
- **#17-#21** **hojas de modelo oficiales** de *The Last Mission* (línea
  limpia, de frente, perfil y espalda): Gon, Killua, Leorio, Kurapika,
  Hisoka (9180×6530 y parecidas). **Lo mejor para proporciones.**
- **#22** hoja de caras de Kurapika (2011).
- **#23-#24** **bocetos del propio Togashi** en X/Twitter (Gon y Kurapika con
  ojos rojos).
- **#28** manga, capítulo 2: los tres aspirantes en el barco (línea limpia).
- **#30** manga, capítulo 268: Meruem cuidando a Komugi.
- **#31** hoja de modelo de **Netero** · **#32** boceto de Togashi del arco
  del Examen.
- **#33** ojo escarlata de Kurapika (3840×2160) · **#35** reencuentro de los
  cuatro (ep. 54).

**`hojas/objetos_01.jpg`** (32 piezas, 796 KB)
- **#1** Licencia de Cazador (3840×2160) · **#2** diseño de la licencia de
  Ging (roja, con las «XX» sobre un triángulo).
- **#3-#4** el libro de **Greed Island** y sus casillas numeradas (001…).
- **#5-#7** diseños de la patineta, el yoyo de Killua y la caña de Gon.
- **#8** las placas del examen: **405** (Gon) y **44** (Hisoka).
- **#9-#10** la adivinación con agua (Killua y Kurapika con un vaso).
- **#11-#13** Kurapika: los Ojos Escarlata en caja, la Cadena de Rastreo y
  los diseños de sus 5 cadenas.
- **#14-#15** cartelas de opening y ending (ep. 76 y 98).
- **#16** tatuaje falso de la Araña en la espalda de Hisoka.
- **#18** Meruem y Komugi jugando al **Gungi**.
- **#21** **carta de Greed Island de Kurapika** (marco rojo, «Lv.1», rango
  «A», caja de texto abajo) (§7).
- **#22-#23** *eyecatch* del anime 1999 (logo en verde).
- **#24-#26** el **alfabeto Hunter**: web de Cazadores en el manga (cap. 70),
  un restaurante con letrero (cap. 5) y la «lección de idioma Hunter» del
  episodio 1 (§6).
- **#28-#31** capturas del juego móvil de **DeNA (2023)**: cajas de diálogo
  (§13).
- **#32** tabla del alfabeto Hunter frente a los kana.

**`hojas/fondos_01.jpg`** (25 piezas, 703 KB)
- **#1** mapa del puerto de Dolle · **#2** Yorknew, 1 de septiembre (3840×2160)
  · **#3** Leorio se va de Yorknew, atardecer.
- **#4** puerto de Greed Island · **#5** Gon y Killua salen de la Isla Ballena.
- **#6-#7** Arena Celestial: la ventana y el mostrador de entrada.
- **#8** la puerta de prueba de los Zoldyck · **#9** Killua abriendo la puerta.
- **#10-#11** el **Árbol del Mundo** · **#12** la **Torre Trick** (los 4 y
  Tonpa) · **#13** examinadores en el dirigible.
- **#14** **mapa del mundo** · **#15** el palacio de las Hormigas · **#16**
  frontera de NGL · **#17** Kakin con Kite.
- **#19** Gon pescando (ep. 1) · **#21** la Araña corriendo bajo la lluvia ·
  **#22** taberna de Cazadores · **#25** Gon y Killua en un restaurante de noche.

### 3.2 Arte oficial fuera de las hojas

- Portada y banner de AniList: https://s4.anilist.co/file/anilistcdn/media/anime/cover/large/bx136-gj0bbCpDNrKG.jpg
  y https://s4.anilist.co/file/anilistcdn/media/anime/banner/136-uHALFo2vGOGd.jpg ✅
- Hojas de modelo en grande: Gon https://static.wikia.nocookie.net/hunterxhunter/images/c/c8/Gon_2011_Design.png ,
  Killua https://static.wikia.nocookie.net/hunterxhunter/images/1/1d/Killua_2011_Design.png ,
  Kurapika https://static.wikia.nocookie.net/hunterxhunter/images/d/db/HxH2011_Kurapika_Yorknew_City_Design.png ,
  Leorio https://static.wikia.nocookie.net/hunterxhunter/images/2/23/Leorio_2011_Design.png ,
  Hisoka https://static.wikia.nocookie.net/hunterxhunter/images/7/77/Hisoka_2011_Design_1.png ✅
- Obra de teatro *Hunter × Hunter The Stage*: fotos del montaje en
  4096×2731 (Leorio, Hisoka) ⚠️ (una fuente, Fandom).
- Variedad conseguida: libro oficial, Blu-ray, pósters de arco, película,
  marca (Zoff), tomos de lujo, calendario, dos juegos de lucha, hojas de
  modelo, bocetos del autor, manga, portada de revista. Con objeto (caña,
  patineta, yoyo, cadenas), en grupo (#2, #4, #6) y en acción (#3, #15).

## 4 · Fan art y 3D, sólo como referencia

**Nunca para pegar.** Sólo para ver poses y volumen.

### 4.1 Fan art (Safebooru, sin +18, con su origen)
- Gon, 2894×4093: https://safebooru.org/images/3448/58fc4798abff60cc64ebae59f0595a021bb96e85.jpg · origen https://twitter.com/hxhsaikaishite/status/1424672142122094598 ⚠️
- Killua, 2000×2000 (el más votado): https://safebooru.org/images/4128/b96c861bced4c0b7fcd0a5d03799c5d5206a4d18.jpg · origen https://twitter.com/cheonsaru/status/1411016065929388035 ⚠️
- Kurapika, 2893×2343: https://safebooru.org/images/897/b713a0308b864a370fac498c2adec46e829c0ef0.jpg · origen Pixiv (member_illust 27092465) ⚠️
- Hisoka, 1996×868 (poco apoyo en Safebooru): https://safebooru.org/images/1000/e6d63bee5e96eae9ebd06b6bece565fa82c0feba.jpg · origen http://i2.pixiv.net/img28/img/drawing-sky/29464986.jpg ⚠️

### 4.2 Modelos 3D descargables (Sketchfab) — licencia y crédito
Crédito exacto: «<nombre del modelo>» by <autor> (Sketchfab), licencia indicada.
- **Hisoka HxH** · CC BY · https://sketchfab.com/3d-models/none-f85b3502129c41b2a0dc24b16a49a8ee ✅
- **Kurapika (hunter x hunter)** · CC BY · https://sketchfab.com/3d-models/none-6ee5aa4542b54abda774804ffce538b9 ✅
- **Killua 256△** (low-poly) · CC BY-NC · https://sketchfab.com/3d-models/none-067c0f854cc940bdbd35eecd46898b34 ⚠️
- **Kite HxH** · CC BY · https://sketchfab.com/3d-models/none-bf4635e8d3c74fc9bd5061a69a954d1a ⚠️
- **Neferpitou** · CC BY · https://sketchfab.com/3d-models/none-7c081daaac4742d3a4a89e6c9fecee90 ⚠️
- **Meruem** · CC BY · https://sketchfab.com/3d-models/none-9588e5ffb8b8446a935d2a722e01a529 ⚠️
- **Nanika** · CC BY · https://sketchfab.com/3d-models/none-d38e2d3683084feea6bc092f43bf7f87 ⚠️
- **Sitio**: el **dirigible del Examen Hunter** · CC BY · https://sketchfab.com/3d-models/none-1334ed31b8ef4542bc4843c79dab12aa ⚠️ — sirve para el concepto B.
- **No encontré** en Sketchfab la Mansión Zoldyck, la Arena Celestial ni
  Greed Island con licencia libre (4 búsquedas). Se descartaron modelos que
  sólo comparten el nombre (Monster Hunter, Mega Man X…).
- Búsqueda: `https://api.sketchfab.com/v3/search?type=models&q=hunter%20x%20hunter&downloadable=true`

## 5 · Sitios, luz, paleta y texturas reales

Paletas medidas con `estilo.py` en fotogramas propios (1280×720).

| Sitio | Fotograma | Luz | Paleta medida |
|---|---|---|---|
| **Isla Ballena**, árbol sobre el mar | [tráiler 0:05](https://www.dailymotion.com/video/x8hzbhf?t=5) | mañana, cielo claro, brillo 63 % | `#6195D9` `#7BB0E8` `#525F45` `#343930` `#738558` `#95A76E` |
| Bosque de la Isla Ballena, amanecer | OP1 0:03 | contraluz, silueta, brillo 25 % | `#070506` `#160C0E` `#583B41` `#685064` `#9D6168` `#CE928D` |
| **Bosque de las Hormigas, incendiado** | [clip ep. 131, 0:20](https://www.dailymotion.com/video/x4jib2p?t=20) | noche, fuego, brillo 31 %, saturación 60 % | `#552723` `#251412` `#3D1C17` `#150C09` `#743229` `#A23C2F` `#90633F` |
| Acantilados de Yorknew, noche | [clip Uvogin 0:48](https://www.dailymotion.com/video/x816c25?t=48) | luna roja, brillo 46 % | `#673D2A` `#71442E` `#5A3626` `#8C5A3D` `#7E4E35` `#9C6847` |
| **Arena Celestial**, el ring | [clip Kastro 0:24](https://www.dailymotion.com/video/x816bz2?t=24) | foco de estadio, brillo 83 %, saturación 18 % | `#FBFAF1` `#EDF0D4` `#D7DDB7` `#F9E982` `#B7C0A1` `#A8957F` |
| Cielo con montañas nevadas | ED1 0:57 | día frío, brillo 57 % | `#121218` `#4C91CD` `#8EC8E8` `#67B2DD` `#2B2D3D` `#4E5266` |
| Cristales de colores (fondo decorativo) | ED1 0:12 | oscuro, brillo 39 % | `#312936` `#4B4354` `#72687E` `#E4F1E7` `#225F2B` `#4CBD59` |

Opening 1 y ending 1 (Internet Archive, BD sin créditos):
https://archive.org/download/hunter-x-hunter-2011-op-1-6-creditless_202505/Hunter%20x%20Hunter%20%282011%29%20NCOP%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4
y https://archive.org/download/HUNTER-x-HUNTER-2011-ed-1-6-creditless/Hunter%20x%20Hunter%20%282011%29%20NCED%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4 ✅

**Otros sitios con imagen** (sin paleta medida): Yorknew (fondos #2-#3),
Torre Trick (#12), dirigible (#13), puerta Zoldyck (#8-#9), Árbol del Mundo
(#10-#11), NGL (#16), palacio de Kakin
(https://static.wikia.nocookie.net/hunterxhunter/images/f/fe/92_-_palace.png) ⚠️.

**Texturas reales (CC0, ambientCG)**
- Roca y musgo del bosque: https://ambientcg.com/a/Rock064 · tierra quemada: https://ambientcg.com/a/Rock063 · roca de acantilado: https://ambientcg.com/a/Rock058
- Suelo del ring o de interior: https://ambientcg.com/a/WoodFloor064
- Punto del jersey de Killua: https://ambientcg.com/view?id=Fabric061 · cuero del maletín de Leorio: https://ambientcg.com/view?id=Leather037 · papel de la licencia o del mapa: https://ambientcg.com/view?id=Paper001
- ⚠️ **No se buscó** metal para las cadenas de Kurapika.

## 6 · Tipografía: una letra para cada uso, y el alfabeto Hunter

### 6.1 Lo que se ve en pantalla (mirado)
- **El logo**: «HUNTER» arriba en blanco con borde rojo, **el mismo
  «HUNTER» debajo boca abajo y en espejo** (rojo-naranja), una **«×» verde
  grande** en medio y dos «ハンター» pequeños en katakana a los lados. Visto en el
  [OP1 0:21](https://archive.org/download/hunter-x-hunter-2011-op-1-6-creditless_202505/Hunter%20x%20Hunter%20%282011%29%20NCOP%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4?t=21)
  y en el [tráiler 1:29](https://www.dailymotion.com/video/x8hzbhf?t=89) ✅.
  En los *eyecatch* de 1999 el logo es **verde** (objetos #22-#23).
- El logo es **rotulación hecha a mano**, no una letra comercial. Diseño del
  logo (1999): **Akira Michikawa** (AniList). Fans lo comparan con Arial Black
  ⚠️ (https://betterstudio.com/fonts/hunter-x-hunter-font/ , https://www.dafont.com/forum/read/24227/hxh-font).
- **Rótulos del tráiler VIZ**: letra **con serifa**, blanca, en mayúsculas,
  con una línea pequeña encima («A GREAT ADVENTURE» / «BEGINS»), sobre un
  **mapa viejo marrón** con signos del alfabeto Hunter en la esquina. Visto
  en [0:25](https://www.dailymotion.com/video/x8hzbhf?t=25) y [0:41](https://www.dailymotion.com/video/x8hzbhf?t=41) ✅.
- **El signo «×»** está en todos los títulos: «Departure × And × Friends»,
  «Anger × And × Light» ✅ (https://hunterxhunter.fandom.com/wiki/Episode_1_(2011)).

### 6.2 El alfabeto Hunter (lo que un fan reconoce al instante)
- La serie tiene **su propia escritura**: un signo por cada kana japonés.
  Tabla en `objetos_01.jpg` #32; «lección de idioma Hunter» (ハンター語講座) en
  el ep. 1 (#26); letreros del manga (#24 web de Cazadores, #25 restaurante).
- Sale en la **Licencia de Cazador** (panel gris-azulado con texto en este
  alfabeto) ✅ (https://hunterxhunter.fandom.com/wiki/File:Hunter_License_card.PNG)
  y como **fondo rosa-morado detrás de Kurapika** en el [OP1 0:30](https://archive.org/download/hunter-x-hunter-2011-op-1-6-creditless_202505/Hunter%20x%20Hunter%20%282011%29%20NCOP%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4?t=30)
  (visto por el redactor; la parte de vídeo lo llamó «cartas de Hisoka»).
- Uso en la lámina: **como adorno** (cabeceras, sellos, bordes), nunca para
  el texto que hay que leer. ⚠️ No encontré una letra libre del alfabeto
  Hunter: habría que dibujarla con la tabla #32.

### 6.3 Una letra libre para cada uso

Todas comprobadas con `fontTools`: traen **tildes, ñ, ¿ y ¡** (salvo aviso).

| Uso | Cómo es en la serie | Letra libre | Licencia |
|---|---|---|---|
| Logo o título | rotulación a mano, sans muy gruesa | **Anton** o **Archivo Black** ✅ | OFL (Google Fonts) |
| Rótulo tipo tráiler | serifa clara, mayúsculas | ⚠️ no se comprobó ninguna serifa; propuesta sin probar | — |
| Globo normal | ⚠️ no se pudo abrir una página del manga; por convención de Jump: óvalo de línea fina, sans clara | **Anime Ace 2.0 BB** (Blambot) ⚠️: DECISIONES dice que Anime Ace **no trae ¿ ni ¡** (caso Haikyuu) | gratis |
| Grito | ⚠️ convención: globo dentado, letra más grande | **Bangers** ✅ | OFL |
| Pensamiento | ⚠️ la serie usa mucho la **voz en off** del narrador en vez de nube | **Caveat** ✅ | OFL |
| Onomatopeya | ⚠️ katakana grande dentro del dibujo (convención) | **Dela Gothic One** ✅ | OFL |
| Cartel del mundo | alfabeto Hunter (§6.2) | dibujarlo; para el español, Archivo Black | — |
| Interfaz de juego | *Nen × Impact*: HUD de lucha, sans condensada ⚠️ | **Barlow Condensed** | OFL |
| Subtítulos o créditos | ⚠️ sin confirmar | **Lato** o **Noto Sans** | OFL |

Enlaces: https://fonts.google.com/specimen/Anton ·
https://fonts.google.com/specimen/Archivo+Black · https://fonts.google.com/specimen/Bangers ·
https://fonts.google.com/specimen/Caveat · https://fonts.google.com/specimen/Dela+Gothic+One ·
https://blambot.com (Anime Ace). **Aviso:** para el globo, mejor Comic Neue
(la solución que se usó en Haikyuu) que Anime Ace, por los ¿ y ¡.

## 7 · Cómo hablan y piensan en pantalla: el cuadro de diálogo

**No es una burbuja blanca.** Lo que es de verdad de Hunter x Hunter:

1. **La tarjeta de rótulo del tráiler** (visto, [0:25](https://www.dailymotion.com/video/x8hzbhf?t=25), [0:57](https://www.dailymotion.com/video/x8hzbhf?t=57)):
   mapa viejo en marrón como fondo, texto blanco con serifa, una línea pequeña
   arriba y la grande abajo, signos del alfabeto Hunter en la esquina. Es la
   forma más «oficial» de poner texto en esta serie ✅.
2. **La carta de Greed Island** (`objetos_01.jpg` #21): marco rojo, arriba
   «Lv.1», el nombre y el rango («A»); en medio la ilustración; **abajo una
   caja de texto** clara con borde rojo. Sirve de cuadro de diálogo con
   nivel y rango ✅ (https://hunterxhunter.fandom.com/wiki/Greed_Island_Card_Lists).
3. **La Licencia de Cazador**: panel negro con el rombo rojo `#B4181E` y un
   panel claro con texto en alfabeto Hunter. Sirve de «ficha», no de globo
   ✅ (medido con Pillow en el render 3840×2160; ⚠️ foto en 3D girada).
4. **La placa del examen**: disco blanco con número negro (405, 44, 404)
   (`objetos_01.jpg` #8) ✅.
5. **El nombre de la técnica se grita**: Gon anuncia «¡Piedra… Papel…
   Tijera!» (Jajanken) antes de golpear ✅ (https://hunterxhunter.fandom.com/wiki/Nen).
6. **Kanji de técnica en pantalla**: 「変」 grande sobre negro cuando Kurapika
   cambia ([clip 2:51](https://www.dailymotion.com/video/x816c25?t=171)) ✅.
7. **Pensamientos**: la serie los cuenta con **voz en off del narrador**,
   no con nube: en el ep. 131, de [14:00](https://archive.org/download/OKanimeHunterXHunter131720pUlquiorraCifer/%5BOKanime%5D%20Hunter%20x%20Hunter%20-%20131%20%5B720p%5D%5BUlquiorra%20Cifer%5D.mp4?t=840)
   a [19:00](https://archive.org/download/OKanimeHunterXHunter131720pUlquiorraCifer/%5BOKanime%5D%20Hunter%20x%20Hunter%20-%20131%20%5B720p%5D%5BUlquiorra%20Cifer%5D.mp4?t=1140)
   casi todo es narrador ⚠️ (observación del equipo). Idea para la lámina:
   una franja de narrador arriba, separada del personaje.
8. **Juegos**: en el juego móvil de DeNA (2023) la caja es **un rectángulo
   blanco con el nombre en una pestaña encima y «▶▶» abajo a la derecha**
   (objetos #29-#30, versión china) ⚠️ visto sólo en la hoja.

⚠️ **No se pudo abrir una página del manga** (Manga Plus y Viz son sólo
JavaScript; TV Tropes y Wayback bloqueados): la forma exacta del globo,
el grito y la nube de HxH queda por ver.

## 8 · Los personajes: qué transmiten, su cara en cada emoción y sus dinámicas

Carácter de las fichas de la wiki y de AniList (https://anilist.co/character/30 ,
/27 , /28 , /29 , /31); caras y gestos de fotogramas propios.

### Gon Freecss — el protagonista
- **Quién es**: 11-12 años, criado por su tía Mito en la Isla Ballena. Busca a
  su padre, Ging, un Cazador famoso. Amable, rústico, **malo en matemáticas**,
  olfato «casi de perro», muy bueno con los animales. Potenciador: sencillo y
  terco ✅ (wiki + AniList).
- **Qué transmite**: alegría limpia y confianza total. Por eso duele tanto su
  ira del ep. 131: pierde el control por primera vez.
- **Cómo habla**: frases cortas y directas, sin ironía; pide las cosas sin
  rodeos («Dependo de ti, Killua»). Grita el nombre de su técnica ✅.
...
### Killua Zoldyck — el más querido
- **Quién es**: 12 años, hijo de la familia de asesinos Zoldyck; se escapó
  para presentarse al examen. Pícaro y alegre, **grosero con desconocidos y
  mayores**, piensa muy rápido, **goloso** ✅ (wiki).
- **Qué transmite**: el público se siente **protector** de él: pasa de
  asesino educado para no sentir a alguien que protege a Gon (§22).
- **Cómo habla**: irónico y cortante; con Gon se queja pero cumple («Suena muy
  egoísta»). En japonés e inglés lo dobla una mujer; en latino 1999 un hombre,
  en 2011 una mujer ✅.
- **Gesto de dibujo**: cuando hace una travesura le salen **orejas y bigotes
  de gato** (gag recurrente) ✅ (wiki, Trivia). En modo asesino los ojos se
  afilan (wiki).
- **Su cara**:
  - picardía: sonrisa ladina en el [ED1 0:18](https://archive.org/download/HUNTER-x-HUNTER-2011-ed-1-6-creditless/Hunter%20x%20Hunter%20%282011%29%20NCED%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4?t=18) (fondo morado) ✅
  - calma/alegría suave: [OP1 1:03](https://archive.org/download/hunter-x-hunter-2011-op-1-6-creditless_202505/Hunter%20x%20Hunter%20%282011%29%20NCOP%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4?t=63) (visto: sonríe entre flores amarillas)
  - miedo/preocupación: [tráiler 0:54](https://www.dailymotion.com/video/x8hzbhf?t=54) ✅
  - sorpresa: en el público, [clip Kastro 0:10](https://www.dailymotion.com/video/x816bz2?t=10) y [1:13](https://www.dailymotion.com/video/x816bz2?t=73) ✅
  - horror: [clip ep. 131, 0:29](https://www.dailymotion.com/video/x4jib2p?t=29) ✅
  - vergüenza: ⚠️ sin fotograma.

### Kurapika — el segundo más querido (primero en Animate Times)
- **Quién es**: 17 años, **último del clan Kurta**, masacrado por la Araña
  (la Brigada Fantasma), que se llevó los **Ojos Escarlata** de todos. Frío,
  culto, reservado; cariñoso con sus amigos ✅ (wiki + AniList).
- **Qué transmite**: dolor contenido y dignidad; cuando se rompe, asusta.
- **Cómo habla**: formal, casi de adulto; en japonés usa *watashi* en público
  y *ore* en sus pensamientos ✅ (wiki). Párrafos calmados; gritos cortos
  cuando pierde el control.
- **Objeto**: las **cadenas** de la mano derecha (objetos #13); tabardo azul.
- **Su cara**:
  - decisión: tres cuartos, ojos entrecerrados, [tráiler 0:53](https://www.dailymotion.com/video/x8hzbhf?t=53) ✅
  - **rabia**: **ojo escarlata**, [tráiler 1:04](https://www.dailymotion.com/video/x8hzbhf?t=64) ✅ (visto por el redactor)
  - dolor: de rodillas, [tráiler 1:00](https://www.dailymotion.com/video/x8hzbhf?t=60) ✅
  - indignación: sangre en la boca, [clip 3:59](https://www.dailymotion.com/video/x816c25?t=239) ✅
  - alegría, miedo, vergüenza: ⚠️ sin fotograma.

### Leorio Paradinight — el grandullón
- **Quién es**: parece viejo pero es adolescente (193 cm). Dice que sólo
  quiere dinero; en verdad quiere ser **médico** para curar gratis, porque un
  amigo murió de una enfermedad curable ✅ (wiki + AniList).
- **Qué transmite**: humor y corazón. Mezcla de payaso y orador.
...
- **Quién es**: mago-bufón, 187 cm, **cartas de póker** como arma. Sólo le
  importa pelear con gente fuerte; deja crecer a Gon para «disfrutarlo» más
  tarde ✅ (wiki + AniList).
- **Qué transmite**: peligro elegante; incomoda y fascina.
- **Cómo habla**: burlón, siempre sonriendo, **alarga las vocales** y usa ❤ y
  ♠ en el manga; **en latino 2011 habla con acento francés** ✅ (wiki, Trivia).
- **Marcas**: **estrella en la mejilla derecha y lágrima en la izquierda**
  (wiki); en el anime 2011 cambian de color. Uñas largas.
- **Su cara**: sonrisa de lado, [clip 1:33](https://www.dailymotion.com/video/x816bz2?t=93) ✅ · risa loca, [ED1 0:36](https://archive.org/download/HUNTER-x-HUNTER-2011-ed-1-6-creditless/Hunter%20x%20Hunter%20%282011%29%20NCED%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4?t=36) ✅ · el resto ⚠️.

### Secundarios queridos
- **Chrollo Lucilfer**: líder de la Araña, calmado, carismático, habla en
  párrafos de filósofo y nunca grita ✅.
- **Illumi Zoldyck**: hermano mayor de Killua, cara sin expresión y voz
  alegre; le **clavó una aguja en la cabeza** a Killua «para protegerlo» ✅.
- **Netero**: presidente de la Asociación, más de 110 años, bromista y
  retorcido ✅.
- **Meruem y Komugi**: el rey de las Hormigas y la niña ciega que le gana al
  Gungi ✅.
- **Kite**: el primer Cazador que ve Gon; le deja la licencia de Ging ✅.

### Dinámicas (para láminas en grupo)
- **Gon pide, Killua se queja y cumple** ([Cazador X, 1:20](https://www.dailymotion.com/video/xcg420?t=80)).
- **Kurapika y Leorio** discuten primero (por dinero y valores) y luego son amigos ✅.
- **Hisoka ve a Gon como un «juguete»** que quiere ver crecer ✅.
- **Illumi y Killua**: cariño que da miedo; Killua tiembla al oír su nombre ✅.
- **Leorio** es el adulto payaso entre tres niños listos; en el ED1 1:15 posa
  con la mano en la nuca mientras los demás están quietos (visto).

## 9 · ¿Quién es el más querido?

| Encuesta | 1.º | 2.º | 3.º | Fuente |
|---|---|---|---|---|
| Jump, 1.ª oficial | **Killua** 13 728 | Kurapika 13 498 | Gon 3 929 (Hisoka 1 498, Leorio 1 015) | https://hunterxhunter.fandom.com/wiki/First_character_popularity_poll ✅ |
| Jump, 2.ª oficial | **Killua** | Kurapika 7 176 | Gon | fichas de la wiki ✅ |
| Jump, 3.ª oficial | **Killua** | Kurapika 3 467 | Gon | fichas de la wiki ✅ |
| AniList (favoritos) | **Killua** 34 827 | Kurapika 20 708 | Gon 15 398 (Hisoka 14 150, Chrollo 9 554) | https://anilist.co/anime/136 ✅ |
| Animate Times (Japón, reciente) | **Kurapika** | — | Killua (4.º Illumi, 5.º Chrollo, 7.º **Gon**) | https://www.cbr.com/hunter-x-hunter-character-popularity-poll-animate-times/ + https://gamerant.com/hunter-x-hunter-best-character-japan/ ✅ |

**Conclusión**: **Killua** es la apuesta segura. **Kurapika** es la segunda y
gana lo más reciente. Los villanos (Hisoka, Chrollo, Illumi) tienen fans
fieles que superan a Gon. ⚠️ No encontré una encuesta hispana.

## 10 · Doblaje latino y frases textuales

### 10.1 Hay dos doblajes latinos distintos

| | **Cazador X** (anime 1999) | **Hunter × Hunter** (anime 2011) |
|---|---|---|
| País y estudio | Colombia, **Provideo** | México, **MCS / Grupo Macías** |
| Dirección | **Orlando Arenas** | **Gabriel Ortiz** (traducción: Laura Brun) |
| Para | Televix (emitido 2005-2006) | VIZ Media; en **Netflix** desde agosto de 2023 |
| Fuentes | https://doblaje.fandom.com/es/wiki/Cazador_X + https://dubdb.fandom.com/wiki/Cazador_X ✅ | https://doblaje.fandom.com/es/wiki/Hunter_%C3%97_Hunter + https://www.3djuegos.lat/anime/netflix-lanza-anime-hunter-x-hunter-completo-doblaje-para-latam-asi-suena-gon-hisoka-meruem-chrollo-espanol-latino + https://www.wdnes.com/2023/08/conozca-al-elenco-latino-de-hunter-x.html ✅ |

- El de 2011 se hizo **desde el doblaje inglés de VIZ**: por eso dice
  «Yorknew» (no Yorkshin), «Brigada Fantasma» (no Genei Ryodan) y «Melody»
  (no Senritsu) ✅ (Doblaje Wiki).
- En **Cazador X**, Gon y Killua tienen **voz de hombre**; en 2011, de mujer ✅.

### 10.2 Reparto (cada nombre en dos fuentes)

| Personaje | Cazador X (1999) | 2011 |
|---|---|---|
| Gon | **Leonardo Salas** | **Susana «Susy» Moreno** (Iris en Pokémon) |
| Killua | Carlos Alberto Gutiérrez | **Verania Ortiz** (de niño, Mateo Mendoza) |
| Kurapika | Bernardo Duque | **David Ramos** |
| Leorio | Orlando Arenas (el director) | **Miguel de León** |
| Hisoka | Carlos Villegas | **Gerardo Reyero** (Freezer), con acento francés |
| Netero | Camilo Rodríguez | Jesse Conde |
| Chrollo | Carlos Jiménez («Kuroro Luciful») | Óscar López |
| Illumi | Tirza Pacheco | Eduardo Martínez |
| Zeno | Alfonso Grau | Jorge Roig |
| Meruem / Komugi | — | Eleazar Muñoz / Wendy Malvárez |
| Ging / Silva | — | Marcos Patiño / Jorge Ornelas |
| Feitan / Machi / Phinks | — | Diego Becerril / Valentina Souza / Diego Estrada |

- Curiosidades: Susana Moreno contó que **compitieron 3 actrices y 1 actor**
  por Gon (ANISON USA: https://www.youtube.com/watch?v=pkNcNEce7ZE); Verania
  Ortiz grabó **desde Francia**; **Victoria Ramírez** (Kalluto) es su hermana
  menor en la vida real ✅.

### 10.3 Frases textuales (Cazador X, clip de Dailymotion, `voz.py`)
Clip: https://www.dailymotion.com/video/xcg420 (384 s). Nombres revisados a oído.
- A Killua: «Finalmente hablaste como tú, Killua.» ⚠️ (la parte dice que
  lo dice Killua, pero lleva su nombre al final: quién habla, sin confirmar) · [1:10](https://www.dailymotion.com/video/xcg420?t=70)
- Gon: «Dependo de ti, Killua.» — Killua: «Suena muy egoísta.» · [1:20](https://www.dailymotion.com/video/xcg420?t=80) ✅
- Silva Zoldyck: «Si quieren que me encargue de asesinar a alguien, llámenme. Les daré el 30% de descuento.» · [2:10](https://www.dailymotion.com/video/xcg420?t=130) ✅
- Chrollo: «Bueno, la verdad es que mis amigos me llaman líder.» · [3:50](https://www.dailymotion.com/video/xcg420?t=230) ✅
- Chrollo (tal como lo dejó Whisper; revisar a oído el «Creas» ⚠️): «¿Creas en la vida después de la muerte? Realmente no creo en la vida después de la muerte... El arte de adivinar es para el bienestar de las personas que están vivas.» · [5:24](https://www.dailymotion.com/video/xcg420?t=324) ✅
- Voz del clip: registro medio (170 Hz), muy expresiva (23,5 semitonos),
  rápida (3,42 palabras/s) ⚠️ (varios personajes mezclados).
- ⚠️ **Del doblaje 2011 no hay frase textual**: Netflix no deja bajar y no
  hay clips doblados oficiales abiertos. Para el dueño (§28).

## 11 · Música y sonido

Anime 2011: **Madhouse**, dir. Hiroshi Kōjina, música **Yoshihisa Hirano**
(⚠️ el compositor sólo en la wiki). Anime 1999: música Toshihiko Sahashi,
efectos Akihiko Matsuda (AniList).

| Tema | Artista | Episodios | Ambiente |
|---|---|---|---|
| OP «**Departure!**» (v1, v3, v4, v6) | Masatoshi Ono | 1-26, 50-75, 137-148 | aventura, sol naciente, correr hacia la luz ✅ |
| OP «Departure! -second version-» | Masatoshi Ono | 27-49, 76-136 | ✅ |
| ED «Just Awake» | Fear, and Loathing in Las Vegas | 1-26 | amistad, cristales de colores, Hisoka riendo ✅ |
| ED «Hunting For Your Dream» | Galneryus | 27-58 | ✅ |
| ED «Reason» | Yuzu | 59-75 y 147 (también la película) | ✅ |
| ED «Nagareboshi Kirari» (流れ星キラリ) | Yuzu | 76-98 | ✅ |
| ED «Hyōri Ittai» (表裏一体) | Yuzu | 99-146 | ✅ |

Fuentes: https://hunterxhunter.fandom.com/wiki/Departure! ·
https://hunterxhunter.fandom.com/wiki/Just_Awake · https://hunterxhunter.fandom.com/wiki/Reason ·
https://hunterxhunter.fandom.com/wiki/Hy%C5%8Dri_Ittai ✅ (wikitext con episodios).

- **OP1 mirado entero**: sol naciendo (0:03), Gon corre por un túnel (0:09),
  gaviotas y logo (0:18-0:21), Kurapika con fondo de alfabeto Hunter (0:30),
  Killua en patineta ante una ciudad (0:39), los 4 corriendo hacia un aura
  verde (0:45), Netero (0:48), Hisoka con la mano abierta (1:09), Gon solo en
  un vacío blanco (1:12) ✅.
- **ED1 mirado entero**: Gon con la caña al hombro en blanco y negro (0:03),
  los 4 retratos sobre cristales de color (0:12-0:18), la Araña en sepia
  (0:21), los 4 en un tronco caído en un bosque nublado (0:27), Hisoka ríe
  (0:36), pelea ante un atardecer rojo (0:45), los 4 cayendo con montañas
  nevadas (0:57), los 4 en fila de pie (1:18) ✅.
- **Efectos que se reconocen**: el «clac» metálico de las cadenas de Kurapika
  y el rugido grave del aura de Gon ⚠️ (de oído, una fuente).
- ⚠️ **No confirmé** qué tema suena en las escenas que hacen llorar.

## 12 · Vídeos y tendencias

| Vídeo | Enlace | Qué sirve |
|---|---|---|
| Tráiler oficial VIZ | https://www.dailymotion.com/video/x8hzbhf | rótulos, placa 404, ojo escarlata (§2.1) |
| Ira de Gon (ep. 131) | https://www.dailymotion.com/video/x4jib2p | [0:21](https://www.dailymotion.com/video/x4jib2p?t=21) aura roja |
| Kurapika vs Uvogin | https://www.dailymotion.com/video/x816c25 | [2:51](https://www.dailymotion.com/video/x816c25?t=171) 「変」 |
| Hisoka vs Kastro | https://www.dailymotion.com/video/x816bz2 | [0:37](https://www.dailymotion.com/video/x816bz2?t=37) maquillaje |
| Cazador X doblado | https://www.dailymotion.com/video/xcg420 | frases latinas (§10.3) |
| OP1 y ED1 sin créditos | Internet Archive (§5) | logo, poses de grupo |
| Episodios 131 y 147 enteros | `partes/episodios.md` | minuto a minuto |

- **TikTok**: *edits* de Gon y Killua con millones de «me gusta» (uno con 1,9
  millones y 13,9 mil comentarios, marzo de 2025), casi siempre de su amistad
  o de la ira de Gon ⚠️ (búsqueda web; TikTok no deja bajar).
- Hay tráileres recientes de *Nen × Impact* y muchos AMV: la serie sigue viva.
- ⚠️ No encontré un videoensayo con minuto ni una tendencia en Dailymotion.

## 13 · Videojuegos de la franquicia

Lista: https://hunterxhunter.fandom.com/wiki/List_of_Hunter_%C3%97_Hunter_Video_Games ✅ (más de 25 títulos desde 2000).

- **Primeros juegos (2000-2004, sólo Japón)**: WonderSwan, Game Boy Color, PS1
  y PS2 (RPG y aventura; *Phantom of Greed Island*, *Greed Island*…).
- **Cruces**: *Jump Super Stars*, *Jump Ultimate Stars*, *J-Stars Victory Vs*,
  *Jump Force* (arte en personajes #13-#14), *Puzzle & Dragons*, *Monster
  Strike*, *Monster Hunter XX*, *Knives Out* ✅.
- ***Greed Adventure*** (Bandai Namco, móvil): de diciembre de 2018 al 14 de
  enero de 2020; historia original «Greed Island 2» ✅ (https://hunterxhunter.fandom.com/wiki/Hunter_%C3%97_Hunter_Greed_Adventure).
- **Juego móvil de DeNA (2023)** ⚠️: en `objetos_01.jpg` #28-#31 se ven su
  mundo 3D en *cel shading*, un menú de misiones a la izquierda, iconos
  redondos a la derecha y la **caja de diálogo blanca con el nombre en una
  pestaña gris y «▶▶»** (versión china). `fondos_01.jpg` #18: pantalla de
  carga con Kurapika y un «83 %».
- ***Nen × Impact*** (el actual): lucha 2.5D, de **Eighting**, publica
  **Bushiroad Games** (Japón) y **Arc System Works** (mundo); salió el **17 de
  julio de 2025** para PS5, Switch y Steam; 16 personajes, 3 contra 3 ✅
  (https://hunterxhunter.fandom.com/wiki/Hunter_%C3%97_Hunter%3A_Nen_%C3%97_Impact).
  Reseñas: modelos en *cel shading* fieles al anime; «modo historia» que es
  un tutorial; poco presupuesto ✅ (https://www.thegamer.com/hunter-x-hunter-nen-x-impact-review/ ,
  https://butwhytho.net/2025/07/hunter-x-hunter-nen-x-impact-review/).
  Visual oficial en personajes #15 (letra de pincel roja «NEN IMPACT»).
- ***Nen × Survivor***: sólo una página corta en la wiki ⚠️.
- **El juego dentro de la serie: Greed Island**. Consola ficticia
  **JoyStation**; sólo lo juegan usuarios de Nen; el jugador entra con el
  cuerpo; libro con casillas numeradas y **cartas de hechizo** (objetos
  #3-#4, #21) ✅ (https://hunterxhunter.fandom.com/wiki/Greed_Island).
- ⚠️ **No pude abrir** *Nen × Impact* (sin Steam aquí): su interfaz exacta
  queda por ver.

## 14 · Lo que ama el fandom, y qué NO hacer

**Lo que todo fan reconoce**
- **«Hiatus × Hiatus»**: el chiste de las pausas larguísimas de Togashi (por
  su espalda). El fandom lo dice con cariño ✅ (https://knowyourmeme.com/memes/subcultures/hunter-x-hunter).
- **«Gon-san»**: Gon adulto y furioso del ep. 131, plantilla de meme de
  «furia contenida» ✅ (https://knowyourmeme.com/memes/gon-san).
- La **amistad Gon-Killua**, sobre todo en TikTok (§12).
- Los **villanos queridos**: Hisoka, Chrollo, Illumi y Meruem tienen su propio
  fandom ✅.
- El **ojo escarlata**, las **cartas de Hisoka**, la **placa 405**, «Jajanken»,
  el **signo ×** y el **alfabeto Hunter**.

**Qué NO hacer**
1. No dibujar a Gon **sin su verde o sin su caña**: siempre lleva rastro de
   aventura ✅.
2. No cambiar **al azar el lado** de la estrella y la lágrima de Hisoka
   (estrella a la derecha, lágrima a la izquierda): los fans lo señalan como
   error ⚠️ (fictionhorizon.com, una fuente).
3. No hacer de Hisoka un **bufón gracioso**: el fandom lo toma en serio (la
   wiki lo compara punto por punto con el Joker) ✅.
4. No **mezclar arcos**: la Isla Ballena es azul y verde; las Hormigas,
   rojo sangre y negro.
5. No mezclar la paleta **1999** (apagada) con la **2011** (saturada) ✅.
6. No poner **texto en español dentro de la licencia**: su panel va en
   alfabeto Hunter; el español, en el cuadro de diálogo.
7. No llamar «Genei Ryodan» ni «Yorkshin» a lo que en latino 2011 es
   «Brigada Fantasma» y «Yorknew».
8. No usar una **burbuja blanca genérica** (§7).

## 15 · Poses analizadas por personaje

De vídeo (con minuto) y de hojas oficiales. **Corregidas por el redactor**
donde la parte de vídeo se equivocó (§28).

**Gon** (9)
| # | Dónde | Qué hace | Sirve para |
|---|---|---|---|
| 1 | [OP1 0:09](https://archive.org/download/hunter-x-hunter-2011-op-1-6-creditless_202505/Hunter%20x%20Hunter%20%282011%29%20NCOP%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4?t=9) | corre por un túnel, caña al hombro, mira hacia la luz | animar |
| 2 | OP1 1:12 | solo en un vacío blanco, brazos sueltos | presentar, pensar |
| 3 | [tráiler 0:05](https://www.dailymotion.com/video/x8hzbhf?t=5) | sentado en una rama, caña con las dos manos | esperar, concentrarse |
| 4 | [tráiler 0:12](https://www.dailymotion.com/video/x8hzbhf?t=12) | junto al pez gigante ante el pueblo | celebrar |
| 5 | [tráiler 0:21](https://www.dailymotion.com/video/x8hzbhf?t=21) | promesa con el meñique | prometer, despedirse |
| 6 | ED1 0:03 | caña atravesada sobre los hombros, las dos manos encima (blanco y negro) | presentar, relajado |
| 7 | ED1 1:12 | de pie, **brazos cruzados**, de frente | regañar, esperar |
| 8 | [clip ep. 131, 0:11](https://www.dailymotion.com/video/x4jib2p?t=11) | tendido, transformado, en luz dorada | impacto |
| 9 | personajes #17 | hoja de modelo: frente, perfil y espalda | proporciones |

**Killua** (8)
| # | Dónde | Qué hace | Sirve para |
|---|---|---|---|
| 1 | [OP1 0:39](https://archive.org/download/hunter-x-hunter-2011-op-1-6-creditless_202505/Hunter%20x%20Hunter%20%282011%29%20NCOP%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4?t=39) | en patineta, de perfil, ciudad al fondo | animar |
| 2 | OP1 1:03 | sonrisa suave entre flores | saludar |
| 3 | ED1 0:18 | sentado abrazando las rodillas, sonrisa ladina, fondo morado | presentar, picardía |
| 4 | ED1 0:27 | de pie en el bosque, junto a los otros tres, cielo nublado | grupo tranquilo |
| 5 | [clip Uvogin 0:14](https://www.dailymotion.com/video/x816c25?t=14) | índice levantado: «they must be nuts to steal from the Mafia» | **explicar** |
| 6 | [clip Kastro 0:10](https://www.dailymotion.com/video/x816bz2?t=10) | en el público, boca abierta | reaccionar |
| 7 | [clip ep. 131, 0:00](https://www.dailymotion.com/video/x4jib2p?t=0) | entra corriendo, cuerpo inclinado | urgencia |
| 8 | personajes #18 | hoja de modelo | proporciones |

**Kurapika** (8)
| # | Dónde | Qué hace | Sirve para |
|---|---|---|---|
| 1 | [OP1 0:27](https://archive.org/download/hunter-x-hunter-2011-op-1-6-creditless_202505/Hunter%20x%20Hunter%20%282011%29%20NCOP%201%20%28BD%201280x720%20x264%20Hi444pp%20FLAC%29.mp4?t=27) | corre con la capa al viento | animar |
| 2 | [tráiler 0:47](https://www.dailymotion.com/video/x8hzbhf?t=47) | con la placa 404, mira de lado | presentar (examen) |
| 3 | [tráiler 0:53](https://www.dailymotion.com/video/x8hzbhf?t=53) | tres cuartos, mirada fría | pensar, decidir |
| 4 | ED1 1:18 | de pie, mano en la barbilla | pensar |
| 5 | [clip Uvogin 0:45](https://www.dailymotion.com/video/x816c25?t=45) | de mayordomo, recto | presentar formal |
| 6 | [clip Uvogin 1:08](https://www.dailymotion.com/video/x816c25?t=68) | cadena en el brazo, brazo adelante | desafiar |
| 7 | [clip Uvogin 2:51](https://www.dailymotion.com/video/x816c25?t=171) | ojos escarlata, ceño | activar poder, regañar duro |
| 8 | [clip Uvogin 3:59](https://www.dailymotion.com/video/x816c25?t=239) | sangre en la boca, cejas arriba | indignarse |

**Leorio** (6)
| # | Dónde | Qué hace | Sirve para |
|---|---|---|---|
| 1 | OP1 0:33 | agachado con el maletín, brazo al suelo | ayudar |
| 2 | OP1 0:54 | salta con una pierna adelante, maletín en la mano | animar (cómico) |
...
| # | Dónde | Qué hace | Sirve para |
|---|---|---|---|
| 1 | OP1 1:09 | mano abierta hacia delante, cuerpo de lado | detener, intimidar |
| 2 | ED1 0:36 | carcajada, lengua fuera, aura de colores | provocar |
| 3 | ED1 0:39 | salto de combate, brazos abiertos | atacar |
| 4 | [clip Kastro 0:12](https://www.dailymotion.com/video/x816bz2?t=12) | corre con el brazo adelante | atacar |
| 5 | [clip Kastro 1:04](https://www.dailymotion.com/video/x816bz2?t=64) | mano con aura verde (Bungee Gum) | usar habilidad |
| 6 | [clip Kastro 1:16](https://www.dailymotion.com/video/x816bz2?t=76) | puño hacia cámara, sonrisa | retar |
| 7 | [clip Kastro 1:33](https://www.dailymotion.com/video/x816bz2?t=93) | sonrisa de lado | la sonrisa inquietante |

**Qué pose para qué**
| Acción | Mejor pose |
|---|---|
| Presentar | Gon con la caña al hombro (ED1 0:03) · Kurapika con la placa 404 |
| Explicar | **Killua con el índice levantado** (clip Uvogin 0:14) |
| Celebrar | Gon con el pez (tráiler 0:12) · Leorio mano en la nuca |
| Regañar | Kurapika con ojos escarlata · Gon de brazos cruzados |
| Pensar | Kurapika mano en la barbilla (ED1 1:18) |
| Animar | Killua en patineta · Gon corriendo (OP1) |

## 16 · Vestuario, con hex medidos

Medidos con `estilo.py` sobre las hojas de color del anime 2011 (⚠️ un hex
por fuente; el color general lo confirma la wiki ✅).

| Personaje | Ropa icónica (2011) | Hex medidos |
|---|---|---|
| **Gon** | chaqueta verde con bordes rojizos, camiseta de tirantes, pantalón corto verde, botas verdes; pelo negro de punta con puntas verdes | verde `#3F8632`, verde oscuro `#182717`, piel `#FBCDA7` |
| **Killua** | jersey de cuello alto oscuro, ropa holgada; pelo blanco; patineta (verde en el manga, amarilla en 2011) | morado `#706684`, sombra `#323161`, pelo `#ECE4FB` |
| **Killua, Yorknew** | camisa mostaza abierta, camiseta azul marino, pantalón corto verde petróleo (medido a mano) | `#C6A661` / `#715231`, `#252B32`, `#2E3738` |
| **Kurapika** | tabardo azul con borde rojo (naranja en 1999), traje blanco debajo; traje de Yorknew; desde la Elección, traje azul o negro | azul marino `#282B57`, dorado `#D4B15B`, `#B9B3B4`, `#E9D6D6` |
| **Leorio** | traje azul oscuro, zapatos negros, gafas pequeñas tintadas | traje `#03264F`, piel `#FBD0AC` |
| **Hisoka** | ropa de bufón con ♦ ♣ ♥ ♠; cambia de traje en cada arco; pelo rojo (azul en 1999) | rojo `#C83A57`, pelo (en sombra) `#473B5A` |
| Licencia de Cazador | rombo rojo sobre negro | `#B4181E` |

- **Accesorios** (hojas de *The Last Mission*): patineta
  https://static.wikia.nocookie.net/hunterxhunter/images/d/d1/TLM_Killua%27s_Skateboard_Design.png ,
  yoyo https://static.wikia.nocookie.net/hunterxhunter/images/f/f3/TLM_Killua%27s_Yo-yo_Design.png ,
  caña https://static.wikia.nocookie.net/hunterxhunter/images/0/0a/TLM_Gon%27s_Fishing_Rod_Design.png ,
  cadenas https://static.wikia.nocookie.net/hunterxhunter/images/b/b9/HxH2011_Kurapika_Chain_Designs.png .
- Cambios por arco (wiki): Gon se quita la chaqueta en Greed Island y en las
  Hormigas y lleva el **Collar del Paladín**; Hisoka lleva el anillo de Greed
  Island y pendientes de corazón en la Elección ✅.
- La ropa que todos reconocen: **Gon de verde con la caña**, **Killua de
  morado claro con la patineta**, **Kurapika con el tabardo azul**.

## 17 · Paisajes y fondos de pantalla

- **Sitios con su luz**: ver §5 y `fondos_01.jpg`. Isla Ballena de mañana y
  al atardecer (ep. 38, fondos #5); Yorknew de día (#2) y al atardecer (#3);
  Arena Celestial con foco blanco; bosque de las Hormigas de noche con fuego;
  Kakin con niebla lila (#17); Árbol del Mundo con cielo azul (#10).
- **Mapa del mundo** (1908×1080): https://static.wikia.nocookie.net/hunterxhunter/images/7/76/World_Map.png ✅
- **4K**: frontera de NGL https://static.wikia.nocookie.net/hunterxhunter/images/f/fe/79_-_The_group_entering_the_NGL_Border_Stop.png ,
  Yorknew https://static.wikia.nocookie.net/hunterxhunter/images/7/75/Yorknew_1st_september.png ,
  puerto de Greed Island https://static.wikia.nocookie.net/hunterxhunter/images/5/5e/Greed_Island_Port_%282011_Anime%29.png ⚠️
- **Fondos de fans (Wallhaven)**: Kurapika y Killua, 2808×2840, subido por
  InoxHinata https://w.wallhaven.cc/full/x8/wallhaven-x881rl.jpg · escena 2011,
  2820×1396, Chumry https://w.wallhaven.cc/full/j8/wallhaven-j813vq.jpg · Gon
  2011, 3924×2081, Chumry https://w.wallhaven.cc/full/gj/wallhaven-gjq72d.jpg ⚠️
