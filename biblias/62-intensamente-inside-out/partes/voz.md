# Voz y personajes · Intensamente / Inside Out (Pixar) — Encargo 62

Investigador de voz y personajes. Puntos 7, 8, 12, 13, 20, 21 y 22 de `ENCARGO.md`.
No hay serie hermana. `datos-voz.md` traía sobre todo la ficha de doblaje de la película 1
(«Intensa mente», 2015); la película 2 («Intensa mente 2», 2024, con Ansiedad) se investigó
aquí desde cero porque el recolector no la tenía. Libreta de datos: ✅ = dos fuentes,
⚠️ = una fuente o dudoso.

## 7 · Personajes principales y secundarios: encuestas de popularidad

AniList no sirve para esta obra (es cine, casi no tiene ficha ahí): la tabla que dejó
...
- Encuesta de fans de Popverse (thepopverse.com) sobre Intensa mente 2: repartió el voto sobre
  ...
  página, sólo referenciado por terceros)
- No se encontró una encuesta oficial de Disney/Pixar tipo «personaje favorito» con cifras
  publicadas (a diferencia de animes con encuestas de revista); tampoco encuestas específicas
  en medios latinoamericanos (México, Argentina) sobre el personaje favorito de la saga.
- Dato clave para el dueño: el protagonista humano (Riley) casi no aparece en los rankings de
  fans; el más querido casi siempre es **Bing Bong** (secundario, el amigo imaginario) o
  **Alegría**, no la protagonista — coincide con el aviso del dueño de que «un secundario
  puede ser más querido que el principal».

## 8 · Doblaje latino: reparto, estudio y frases textuales

Fuente base: Doblaje Wiki vía API (`action=parse&prop=wikitext`) para «Intensa mente» (2015) y
«Intensa mente 2» (2024). Estudio: **Taller Acústico, S.C.** (México) ambas películas.
Dirección: Mario Castañeda (película 1) → Ricardo Tejedo (película 2). Traducción/adaptación:
Katya Ojeda (Iturbide) en ambas. Grabado marzo-abril de 2015 (película 1) y abril-mayo de 2024
(película 2).
...
Con `herramientas/voz.py` sobre las muestras oficiales de Doblaje Wiki (Whisper local) — así
se saca la frase tal cual se dice, no de memoria:

- Alegría (Cristina Hernández), muestra «Alegría - IM.ogg» ✅ (audio propio, transcrito):
  - [0:00] «Oye, todo estará bien. Tiene remedio.»
  - [0:03] «En cuanto regresemos al cuartel general, ¿dónde está la estación del tren?»
  - [0:08] «Hey, te gustan las cosquillas, ¿eh? Es el monstruo y aquí viene.»
  - [0:14] «Oye, Bing Bong, mira esto.»
  - Cómo suena: registro agudo (306 Hz), muy expresiva (15.6 semitonos de rango), velocidad
    normal (2.92 palabras/s) — voz brillante, infantil, siempre en tono ascendente de ánimo.
- Temor (Moisés Iván Mora), muestra «Temor - IM.ogg» ✅ (audio propio, transcrito):
  - [0:00] «¿Qué es esa cosa?» · [0:02] «Se me caen los dientes.» · [0:06] «No me digan, no
    trae pantalones.» · [0:08] «¡Qué horror!» · [0:10] «¡Le atiné!»
  - Cómo suena: registro medio (158 Hz), la MÁS expresiva de las dos muestras medidas (31.5
    semitonos de rango — grandes subidas y bajadas, como quiebres de pánico), velocidad
    rápida (3.76 palabras/s): habla atropellado, típico de alguien nervioso.
- Frases del tráiler oficial doblado 1 («'Intensamente' - Tráiler oficial», Dailymotion,
  canal sensacinemx, 2:31 min) ✅ mirado fotograma a fotograma:
  - [0:35] Riley (voz interna): «-Él es Furia. -¿Qué?» (presentación de Furia).
  - [0:55] «¿Qué pasó? ¡Tristeza!» (alguien preocupado al ver a Tristeza tocar un recuerdo).
  - [1:10] Furia, a Alegría: «Nada funciona. ¿Por qué no funciona?»
  - [1:15] Alegría: «Podemos arreglar esto. Sólo tenemos que volver a la sede.»
  - [1:45] Furia, sarcástico, a un unicornio imaginario: «Bueno, adiós. Me encantas.»
  - [1:50] Tristeza (llorando): «No puedes enfocarte en lo malo. Las cosas siempre pueden
    mejorar.»
  - [2:05-2:10] «No tengas miedo... está todo en tu cabeza» (texto de la campaña, no diálogo).
  - Enlace con minuto: https://www.dailymotion.com/video/x88a0ss?t=110 (y análogos con &t=)
- Teaser oficial doblado de Intensa mente 2 («'IntensaMente 2' - Teaser oficial doblado»,
  Dailymotion, sensacinemx, 1:39 min) ✅ mirado fotograma a fotograma:
  - [0:24] «¿Qué podría salir mal?» (texto de campaña, tono irónico previo al caos).
  - [1:00] Furia, ardiendo literalmente de la cabeza, grita mientras un mentalero lo sujeta
    (sin diálogo claro, sólo grito de rabia) — ver fotograma citado en el punto 13.
  - [1:24] «...la película que te hará sentir desagrado en 2024» (texto de campaña).
  - Enlace: https://www.dailymotion.com/video/x8php8l?t=60
...
- **Qué NO hacer** (para no romper la inmersión de un fan):
  ...
  - No poner a Bing Bong «hablando normal y feliz» sin más: su gracia es que es mitad gato,
    mitad elefante, mitad algodón de azúcar, llora dulces y su voz es infantil-rasposa; un
    Bing Bong genérico decepciona al fandom.
  - No usar el nombre en inglés de las emociones nuevas en materiales para el server: el
    doblaje adaptó Anxiety→Ansiedad, Envy→Envidia, Embarrassment→Vergüenza, Ennui→Aburrimiento
    (ver adaptaciones en el punto 8); mezclar idiomas se nota como «hecho sin ver la peli
    doblada».
  - No dibujar el «Cuartel General» (Headquarters) como una nave espacial genérica: es una
    consola redonda con botones de colores y una gran ventana hacia los ojos de Riley — un
    diseño reconocible que un fan nota si se cambia.

## 13 · Descripción profunda de cada personaje

Caras en distintas emociones, vistas fotograma a fotograma en tráilers oficiales doblados
(no hay episodios: son película 1 y película 2/teaser):

| Personaje | Emoción | Episodio | Minuto | Fotograma (enlace) |
|---|---|---|---|---|
| Alegría | Alegría (feliz, al mando) | Tráiler oficial 1 (2015) | 1:35 | https://www.dailymotion.com/video/x88a0ss?t=95 |
| Tristeza | Tristeza (llorando bajo la lluvia) | Tráiler oficial 1 (2015) | 1:50 | https://www.dailymotion.com/video/x88a0ss?t=110 |
| Tristeza | Miedo/sorpresa (grito de espanto) | Teaser oficial 2 (2024) | 0:56 | https://www.dailymotion.com/video/x8php8l?t=56 |
| Tristeza | Miedo/shock (otra escena, vertedero helado) | Tráiler oficial 1 (2015) | 2:15 | https://www.dailymotion.com/video/x88a0ss?t=135 |
| Furia | Rabia (cabeza en llamas, grita) | Teaser oficial 2 (2024) | 1:00 | https://www.dailymotion.com/video/x8php8l?t=60 |
| Desagrado | Asco/enfado (ceño fruncido) | Teaser oficial 2 (2024) | 0:56 | https://www.dailymotion.com/video/x8php8l?t=56 |
| Temor | (no se consiguió fotograma propio en primer plano) | — | — | ⚠️ pendiente, ver «No encontré» |
| Ansiedad | (no aparece de cerca en los 2 tráilers mirados) | — | — | ⚠️ pendiente, ver «No encontré» |

Personalidades oficiales (descripciones de Pixar difundidas en 2015, citadas por Jon Negroni
y Pixar Post) ✅ dos fuentes, más lo visto en tráileres doblados propios:
...
grande, ojos brillantes) — https://www.dailymotion.com/video/x88a0ss?t=95 ✅ (visto).
...
mentalero lo sujeta — https://www.dailymotion.com/video/x8php8l?t=60 ✅ (visto, imagen icónica
del personaje).
...
tiempo («¿Qué es esa cosa?», «¡Qué horror!»). No se consiguió un fotograma propio con su cara
en primer plano en los clips disponibles (⚠️ pendiente para el investigador de vídeo/imagen).

**Ansiedad (Anxiety, película 2)** — personaje nuevo: «una emoción naranja despeinada, experta
en predecir todo lo que puede salir mal en el futuro de Riley» (descripción oficial de Pixar
para el estreno, 2024) ✅. Encarna la ansiedad adolescente: habla rápido, hace listas de
catástrofes, se mueve en círculos. No se encontró un fotograma propio suyo en los dos
...
emociones nuevas (Ansiedad, Envidia, Vergüenza, Aburrimiento) que casi la hacen abandonar su
...
|---|---|---|---|---|---|---|
| Alegría | Que Riley esté feliz, el brócoli le da igual pero intenta que Riley lo vea bien, resolver problemas con optimismo | Que Tristeza «arruine» un buen recuerdo, la idea de que algo no tenga solución | Organizar islas de personalidad, animar al equipo | No aplica (es una emoción, no un ser con fecha de nacimiento) | No aplica (tamaño varía según la escena, es una entidad mental) | Pixar Wiki + descripción oficial Pixar (Pixar Post) ✅ |
| Tristeza | La lluvia (dice que la ayuda a concentrarse en el peso de los problemas), leer, los recuerdos melancólicos | Que la ignoren o le digan que «no ayuda en nada» | Sentarse en el suelo, mirar los recuerdos tristes de Riley | No aplica | No aplica | Doblaje Wiki (dato de interés, línea sobre la lluvia) + Pixar Wiki ✅ |
| Furia | La justicia, que las cosas salgan como él planeó, el hockey (se identifica con la agresividad del deporte) | La injusticia, la publicidad de goma de mascar (TripleDent Gum, gag recurrente en ambas pelis), que le arruinen sus planes | Explotar (literal), gritarle a la tele | No aplica | No aplica | Pixar Wiki + wikitext Doblaje Wiki (canción TripleDent Gum) ✅ |
| Desagrado | La moda, verse bien, señalar lo que está mal en los demás | El brócoli, los ratones muertos, la ropa pasada de moda, que Riley se vea «rara» ante otros | Vigilar la ropa y la comida de Riley | No aplica | No aplica | Pixar Wiki + Doblaje Wiki (dato de interés del brócoli) ✅ |
| Temor | Los planes con salida de emergencia, hacer listas de riesgos | Las sorpresas, los osos (cree ver uno y resulta ser un señor peludo), quedarse sin opciones | Evaluar peligros antes de cualquier actividad | No aplica | No aplica | Pixar Wiki + Doblaje Wiki (gag del oso) ✅ |
| Ansiedad | Planear, anticipar problemas, «cuidar» a Riley a su manera | Perder el control, la incertidumbre | Hacer listas mentales de catástrofes | No aplica | No aplica | Descripción oficial Pixar 2024 (Screen Rant + Yahoo News) ✅ |
| Riley Andersen | El hockey, su familia, San Francisco una vez que le da una oportunidad, la pizza (aunque le decepciona la de brócoli) | Mudarse sin avisar, sentir que no encaja, perder a sus amigas de Minnesota | Hockey (jugadora), antes tocaba el acordeón/imaginación activa de niña | No dada en la wiki; nace en Mineápolis, Minnesota | No dada (crece de 11 a 13 años en la saga) | Pixar Wiki (ficha `age`, sección historia) ✅ |
| Bing Bong | Ayudar a Riley (aunque ya la olvidó a medias), su carrito hecho de golosinas y partes recicladas, cantar «Quién es tu amigo especial» | Que lo olviden, quedarse solo en el Vertedero de la Memoria | Cantar, inventar juegos imaginarios | No aplica | No aplica | Pixar Wiki (Bing Bong) + visto en fotogramas/trivia Doblaje Wiki ✅ |

Nota: como los personajes principales son EMOCIONES (no personas), «cumpleaños» y «altura»
casi nunca aplican — se avisa en cada fila en vez de inventar un dato. Sólo Riley (humana)
podría tener cumpleaños, pero ni la wiki ni el datalore oficial lo precisan; sólo su edad por
película.
...
- No se encontraron canales YouTube con fandub completo y muchas vistas verificables desde
  este servidor (YouTube pide iniciar sesión al abrir video; sólo se pudo ver metadata por
  búsqueda). Sí aparecen por título en buscador: «Intensa-Mente: La memoria de Riley (Doblado
  al español)», «Intensamente 2 - Compilación de Cómic's Fandub Latino», y una playlist
  «FANDUB PARODIA - Escenas en Español Latino» · resultados de búsqueda web ⚠️ (un solo
  listado, no se pudo abrir el video para confirmar vistas ni fecha)
...
- No se encontró un cover en español del tema musical de la película (Inside Out no tiene
  opening/ending tipo anime con letra para cover; su tema principal es instrumental de Michael
  Giacchino), así que no aplica «cover del opening en español» como en otras series del
  servidor — dicho explícitamente para no generar expectativa falsa.
- Parodias/memes hispanos: el meme de «un recuerdo esencial» (adaptación al español de «a core
  memory») circula igual en cuentas hispanas de memes, normalmente sin doblar, usando el
  fotograma de la canica dorada · visto en búsqueda (Know Your Meme + TikTok discover en
  español) ⚠️

## Lo mejor para la lámina

- El fotograma propio de Furia con la cabeza en llamas gritando (teaser 2, min 1:00,
  https://www.dailymotion.com/video/x8php8l?t=60): imagen-emoción más reconocible de toda la
  franquicia, ideal si el canal necesita transmitir «alerta» o «cuidado, esto es intenso».
- La frase de Bing Bong «Llévala a la Luna de mi parte» + su escena: si el canal necesita un
  gancho emotivo real (nostalgia, despedidas), es EL momento que todo fan reconoce al instante.
- Alegría con el mentón apoyado en las manos sonriendo al panel de control (tráiler 1, min
  1:35): pose «feliz, todo bajo control», perfecta para un canal de bienvenida o guía.
- El dato de que Ansiedad la dobla María José Guerrero (no Nayeli Mendoza, que dicen medios
  grandes por error) evita un error vergonzoso si el redactor cita al actor de doblaje.
- El aval de terapeutas y de Paul Ekman: si el servidor quiere presentar la serie como «apta
  para hablar de emociones de verdad» (encaja con canales de actuación/emoción), esto es
  munición de peso, no sólo opinión de fans.

## No encontré

- Encuesta oficial de Disney/Pixar con cifras de «personaje favorito» (tipo revista Shonen
  Jump para anime): no existe un equivalente publicado; busqué «Fandango poll Inside Out 2
  favorite emotion», «encuesta personaje favorito Intensa Mente México», sin resultado con
  cifras reales.
- Cumpleaños y altura exactos de Riley: la wiki sólo da su edad por película (11/12/13), no
  una fecha de nacimiento ni estatura; no lo inventé.
- Fotograma propio con la cara de Temor o de Ansiedad en primer plano: los dos tráileres
  oficiales doblados que pude bajar (Dailymotion, canal sensacinemx) no los muestran de cerca;
  haría falta un tráiler más (o el de la película 2 completo) para conseguirlo — tarea para
  el investigador de vídeo/imagen si hace falta.
- Vistas y fecha exactas de fandubs de YouTube/TikTok: no pude abrir los videos directamente
  (YouTube pide sesión; TikTok no responde a curl ni a `navegar.py` con estos títulos
  concretos); dejé los títulos encontrados por buscador con ⚠️.
- Reddit de Inside Out con encuestas de personaje favorito: probé
...
- Wayback Machine (`web.archive.org`): bloqueado por la política de salida del contenedor en
  ...
  (ej. stitchkingdom.com, que dio 503 en vivo).
