...
Investigador de voz y personajes, encargo 90. Hay una **biblia hermana ya
completa** (43-kaguya-sama-love-is-war, misma obra, otro encargo) cuya
`partes/voz.md` cubre estos mismos 7 puntos a fondo: reparto latino completo,
personalidad de los 6 principales, 3 encuestas de popularidad, gustos de 7
personajes, por qué la aman (con escenas que hacen llorar) y fan dubs. **No
repito esos datos.** El encargo 90 pide fijarse en **comedia y rótulos**; mi
parte de rótulos no aplica (es del investigador de texto), así que profundizo
en **comedia**: transcribo con `voz.py` las muestras de audio del doblaje que
43 NO transcribió (personajes secundarios cómicos: Kei, Nagisa, Tsubasa,
Adolphe, Kobachi, Sr. Shirogane padre), completo personalidad/gustos de esos
mismos secundarios (la wiki en inglés que 43 no miró), busco gags y memes de
comedia distintos a los que ya cubrió 43, y giro el punto 21 hacia las
escenas que hacen **reír**, no llorar (43 ya cubrió el llanto).
...
43 ya confirmó a los 6 principales + narrador con doblaje wiki + ANMTV/SomosKudasai.
...
**Frases textuales nuevas, transcritas con `voz.py` (Whisper) sobre las
muestras oficiales `.ogg` de Doblaje Wiki que 43 no había oído** (nombres
propios revisados a mano, Whisper se equivoca: "Cago" → "Kaguya", "esta
academy" → probablemente "esta escuela" mal pronunciado a propósito por el
actor imitando acento francés):

- **Kei Shirogane** (Amanda Hinojosa), 0:00-0:17: *"Hola, soy la tesorera del
  Consejo Estudiantil de Secundaria. Me llamo Kei Shirogane. Oí una junta con
...
- **Nagisa Kashiwagi** (Yaha Lima), 0:00-0:13: *"No tengo idea de qué hacer
  al respecto (...) me dijeron que ustedes también dan consejo sobre estas
...
- **Tsubasa Tanuma** (Diego Becerril), 0:00-0:16: *"Sí, es que todos en la
  escuela hablan de tu experiencia en el amor, presidente. Por eso pensé que
...
- **Adolphe Pescarolo** (Raúl Anaya), 0:00-0:16: *"Joven Shirogane, ¿por qué
  ...
  le puedo confiar esta academia. Tu verdadero test comienza justo ahora."* —
