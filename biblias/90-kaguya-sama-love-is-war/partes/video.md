...
- El opening («Love Dramatic feat. Rikka Ihara», interpretado por Masayuki Suzuki, Rikka Ihara y Yoshiki Mizuno) y el ending («Sentimental Crisis», Halca) del episodio 2 son los MISMOS de toda la T1, ya identificados por la biblia hermana; aquí se confirma de nuevo viéndolos completos en un episodio distinto (ep. 2, min. 0:56-2:16 y 22:24-23:52) y con dos fuentes de texto propias: [Wikipedia (en), «Kaguya-sama: Love Is War season 1»](https://en.wikipedia.org/wiki/Kaguya-sama:_Love_Is_War_season_1) (director Mamoru Hatakeyama, estudio A-1 Pictures, compositor Kei Haneoka, emisión 12-ene a 30-mar-2019) y [MusicBrainz, release-group «センチメンタルクライシス» (Sentimental Crisis) de halca](https://musicbrainz.org/release-group/20231932-89cd-4306-93d8-5987ab273576) (single, SACRA MUSIC, publicado 2019-02-20) · ✅
...
- Tráiler oficial adicional (colección `movie_trailers` de Turner/Internet Archive, sin voz en off, mismo material base que el tráiler VO de Dailymotion ya citado por la biblia hermana en [dailymotion.com/video/x88pf8w](https://www.dailymotion.com/video/x88pf8w)) · [Internet Archive, turner_video_136312](https://archive.org/details/turner_video_136312) · ⚠️ (confirmado que existe y es de la franquicia por su metadato `subject: Movie, Drama, trailer`, año 2019; no se comparó fotograma a fotograma con el de Dailymotion por tiempo)
- Tráiler oficial en YouTube listado por la ficha oficial de la franquicia: [AniList, anime 101921](https://anilist.co/anime/101921) enlaza `https://www.youtube.com/watch?v=IwpJJiQkZzI` como tráiler oficial y da los enlaces de streaming (Crunchyroll, Netflix) y la web japonesa `kaguya.love/1st` · ✅ (AniList + confirmado que el ítem de Turner en Internet Archive es una copia recortada del mismo material promocional, mismo año 2019)
...
- Wiki de Fandom de la serie: probadas `kaguya-sama.fandom.com`, `kaguyasama.fandom.com`, `kaguya-sama-love-is-war.fandom.com`, `kaguyasamawakokurasetai.fandom.com` y `loveiswar.fandom.com` vía `api.php?action=query&meta=siteinfo` — las cinco dan 404, no parece existir wiki de Fandom dedicada (o usa un nombre distinto que no se localizó en esta tanda).
- «Love Dramatic» (OP) en MusicBrainz: la búsqueda por título es ambigua (más de un millón de grabaciones con palabras parecidas) y no se localizó la ficha exacta del single/EP en esta tanda; sí se confirmó el ED «Sentimental Crisis» con release-group propio.
